...
public:
  ...
  virtual bool send_column_metadata(const std::string &catalog,
                                    ...
                                    uint32_t flags, uint32_t length, uint32_t content_type = 0) = 0;
  ...
  virtual bool send_message(int8_t type, const Message &message, bool force_buffer_flush = false) = 0;
