...
public:
  ...
  */
  ...
  /**
    ...
    logging and debugging system. It is invoked by the Gcs_log_manager::initialize
    and Gcs_debug_manager::initialize methods.
  ...
  */
  ...
  /**
    ...
    It is invoked by the Gcs_log_manager::finalize and Gcs_debug_manager::finalize
    methods during the GCS interface termination procedure, and also by the
    Gcs_log_manager::initialize and Gcs_debug_manager::initialize methods in case a
    logging system has been previously set up.
...
public:
  /**
    The purpose of this method is to force any implementing classes to define
    a destructor, since it will be used by Gcs_log_manager in its finalize method.
  */
...
public:
  ...
  */
  ...
  /**
    ...
    It is invoked by the Gcs_log_manager::finalize method during the GCS interface
    termination procedure, and also by the Gcs_log_manager::initialize method in
...
public:
  ...
  */
  ...
  /**
    Change the current set of debug options by the new debug options expressed as
    an unsigned integer parameter.
