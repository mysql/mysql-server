...
# - "bundled" uses source code in <source dir>/yassl
...
MACRO (MYSQL_USE_BUNDLED_SSL)
  SET(INC_DIRS
    ${PROJECT_SOURCE_DIR}/yassl/include
    ${PROJECT_SOURCE_DIR}/yassl/taocrypt/include
  )
  SET(SSL_LIBRARIES  yassl taocrypt CACHE PATH "SSL libraries to link")
  IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
    SET(SSL_LIBRARIES ${SSL_LIBRARIES} ${LIBSOCKET})
  ENDIF()
  SET(SSL_INCLUDE_DIRS ${INC_DIRS} CACHE STRING "Include directories for SSL usage")
  SET(SSL_INTERNAL_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/yassl/taocrypt/mySTL)
  SET(SSL_DEFINES "-DHAVE_YASSL -DYASSL_PREFIX -DMULTI_THREADED")
  CHANGE_SSL_SETTINGS("bundled")
  ADD_SUBDIRECTORY(yassl)
  ADD_SUBDIRECTORY(yassl/taocrypt)
  GET_TARGET_PROPERTY(src yassl SOURCES)
  FOREACH(file ${src})
    SET(SSL_SOURCES ${SSL_SOURCES} ${PROJECT_SOURCE_DIR}/yassl/${file})
  ENDFOREACH()
  GET_TARGET_PROPERTY(src taocrypt SOURCES)
  FOREACH(file ${src})
    SET(SSL_SOURCES ${SSL_SOURCES}
      ${PROJECT_SOURCE_DIR}/yassl/taocrypt/${file})
  ENDFOREACH()
ENDMACRO()
...
MACRO (MYSQL_CHECK_SSL)
  ...
  ELSEIF(WITH_SSL STREQUAL "system" OR
    ...
    IF(OPENSSL_FOUND AND HAVE_SHA512_DIGEST_LENGTH)
      SET(SSL_SOURCES "")
      SET(SSL_LIBRARIES ${MY_OPENSSL_LIBRARY} ${MY_CRYPTO_LIBRARY} CACHE PATH "SSL libraries to link")
      IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
        SET(SSL_LIBRARIES ${SSL_LIBRARIES} ${LIBSOCKET})
      ENDIF()
