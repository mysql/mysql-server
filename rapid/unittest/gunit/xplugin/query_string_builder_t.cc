...
INSTANTIATE_TEST_CASE_P(InstantiationPositiveTest,
    Query_string_builder_param_testsuite,
    ::testing::Values(Query_and_expected("SELECT ? FROM", "SELECT 'Test' FROM", "Test"),
...
::std::ostream& operator<<(::std::ostream& os, const Query_and_expected_values& query_and_expected) {
  ...
  std::copy(query_and_expected.m_values.begin(), query_and_expected.m_values.end(), out_it);
