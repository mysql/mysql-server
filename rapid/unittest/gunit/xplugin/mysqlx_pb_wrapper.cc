...
Any::Array::Scalar_values &Any::Array::Scalar_values::operator()(
    const Scalar &value) {
  push_back(value);
  return *this;
}

Any::Array::Array(const Scalar &value) { this->operator()(value); }

Any::Array::Array(const Object &value) { this->operator()(value); }
...
Any::Object::Scalar_fields::Scalar_fields(const std::string &key,
                                          const Scalar &value) {
  (*this)[key] = value;
}

Any::Object::Scalar_fields &Any::Object::Scalar_fields::operator()(
    const std::string &key, const Scalar &value) {
  (*this)[key] = value;
  return *this;
}
...
Any::Object::Fields &Any::Object::Fields::operator()(const std::string &key,
                                                     const Any &value) {
  (*this)[key] = value;
  return *this;
}
...
Any::Object::Object(const Scalar_fields &values) {
  for (Scalar_fields::const_iterator i = values.begin(); i != values.end();
       ++i) {
