...
TEST_P(Xcl_session_impl_tests_param_int_option,
...
INSTANTIATE_TEST_CASE_P(
    InstantiationNotSupportedIntOptions,
    Xcl_session_impl_tests_param_bool_option,
    Values(XSession::Mysqlx_option::Read_timeout,
           XSession::Mysqlx_option::Write_timeout,
           XSession::Mysqlx_option::Connect_timeout));
...
INSTANTIATE_TEST_CASE_P(
    InstantiationNotSupportedTextOptions,
...
TEST_F(Xcl_session_impl_tests, xsession_option_allowed_tls) {
  ...
  auto error = m_sut->set_mysql_option(
      XSession::Mysqlx_option::Allowed_tls,
      expected_str_value);
  ASSERT_FALSE(error);
...
TEST_F(Xcl_session_impl_tests,
       set_valid_timeout_value) {
...
TEST_F(Xcl_session_impl_tests_connected, xsession_option_set_fails) {
  ASSERT_EQ(CR_ALREADY_CONNECTED,
      m_sut->set_mysql_option(XSession::Mysqlx_option::Read_timeout,
                              int64_t{10}).error());
  ASSERT_EQ(CR_ALREADY_CONNECTED,
      m_sut->set_mysql_option(XSession::Mysqlx_option::Read_timeout, true).error());
  ASSERT_EQ(CR_ALREADY_CONNECTED,
