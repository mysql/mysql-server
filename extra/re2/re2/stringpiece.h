...
class StringPiece {
 ...
 public:
  ...
  ////////////////
  // This code requires stlport4 library to be installed on Solaris OS 
  // and "-library=stlport4" compiler flag to be enabled. Enabling this
  // library might also impact performance.
  // following methods are anyway not used so commenting them should be fine.
  ////////////////
