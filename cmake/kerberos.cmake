...
MACRO(FIND_SYSTEM_KERBEROS)
  ...
  ELSEIF(WIN32)
	# authentication_kerberos and authentication_kerberos_client plug-ins shall not be officially built on windows,
	# Linux MySQL server with Kerberos and windows java mysql client with Kerberos shall work.
...
MACRO(FIND_CUSTOM_KERBEROS)
  ...
  IF(GSSAPI_INCLUDE_DIR AND GSSAPI_LIBRARIES)
    MESSAGE(STATUS "GSSAPI_INCLUDE_DIR ${GSSAPI_INCLUDE_DIR}")
    SET(GSSAPI_FOUND 1)
