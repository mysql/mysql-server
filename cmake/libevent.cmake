...
MACRO (MYSQL_USE_BUNDLED_LIBEVENT)
  ...
  UNSET(EVENT__DISABLE_BENCHMARK CACHE)
  UNSET(EVENT__DISABLE_SAMPLES CACHE)
  UNSET(EVENT__DISABLE_TESTS CACHE)
  SET(EVENT__DISABLE_BENCHMARK 1)
  SET(EVENT__DISABLE_SAMPLES 1)
  SET(EVENT__DISABLE_TESTS 1)
ENDMACRO()
