...
MACRO (FIND_SYSTEM_EDITLINE)
  ...
  IF(LIBEDIT_FOUND)
    INCLUDE_DIRECTORIES(BEFORE SYSTEM ${EDITLINE_INCLUDE_DIR})
    SET(FOUND_EDITLINE_READLINE FOUND)
    SET(EDITLINE_INCLUDE_DIR ${LIBEDIT_INCLUDE_DIRS})
    IF(BUILD_SHARED_LIBS)
      SET(EDITLINE_LIBRARY ${LIBEDIT_LIBRARIES})
    ELSE()
      SET(EDITLINE_LIBRARY ${LIBEDIT_STATIC_LIBRARIES})
    ENDIF()
  ELSE()
