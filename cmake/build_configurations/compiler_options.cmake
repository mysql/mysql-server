...
IF(UNIX)
  ...
  IF(CMAKE_COMPILER_IS_GNUCC)
    IF(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|AARCH64")
      SET(COMMON_C_FLAGS               "-g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -march=armv8-a+crypto")
    ELSE()
  ...
  IF(CMAKE_COMPILER_IS_GNUCXX)
    IF(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|AARCH64")
      SET(COMMON_CXX_FLAGS               "-g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -march=armv8-a+crypto")
    ELSE()
