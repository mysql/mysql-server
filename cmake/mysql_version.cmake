...
MACRO(GET_MYSQL_VERSION)
  ...
  SET(MYSQL_VERSION_EXTRA_DOT "${EXTRA_VERSION}")
  IF(MYSQL_VERSION_EXTRA_DOT)
    STRING(REGEX REPLACE "^[^A-Za-z]"   ""  MYSQL_VERSION_EXTRA_DOT "${MYSQL_VERSION_EXTRA_DOT}")
    STRING(REGEX REPLACE "[^A-Za-z0-9]" "_" MYSQL_VERSION_EXTRA_DOT "${MYSQL_VERSION_EXTRA_DOT}")
    SET(MYSQL_VERSION_EXTRA_DOT ".${MYSQL_VERSION_EXTRA_DOT}")
  ENDIF()
