...
")
  ...
  ELSEIF(NOT WITHOUT_${plugin} AND NOT ARG_STATIC_ONLY  AND NOT WITHOUT_DYNAMIC_PLUGINS)
    ...
    SET(RPM_FILES plugins.files)
    IF(ARG_TEST_ONLY)
      SET(INSTALL_COMPONENT Test)
      SET(RPM_FILES plugins-testonly.files)
    ENDIF()
    MESSAGE(STATUS "INSTALL_COMPONENT = ${INSTALL_COMPONENT}")
    MYSQL_INSTALL_TARGETS(${target} DESTINATION ${INSTALL_PLUGINDIR} COMPONENT Test)
    INSTALL_DEBUG_TARGET(${target} DESTINATION ${INSTALL_PLUGINDIR}/debug COMPONENT Test)
    # Add installed files to list for RPMs
    FILE(APPEND ${CMAKE_BINARY_DIR}/support-files/${RPM_FILES}
