...
# We want boost 1.60.0 in order to build our boost/geometry code.
...
SET(BOOST_PACKAGE_NAME "boost_1_60_0")
SET(BOOST_TARBALL "${BOOST_PACKAGE_NAME}.tar.gz")
SET(BOOST_DOWNLOAD_URL
  "http://sourceforge.net/projects/boost/files/boost/1.60.0/${BOOST_TARBALL}"
  )
...
IF(NOT BOOST_MINOR_VERSION EQUAL 60)
...
SET(BOOST_PATCHES_DIR "${CMAKE_SOURCE_DIR}/include/boost_1_60_0/patches")

# We have a limited set of source files here:
SET(BOOST_SOURCES_DIR "${CMAKE_SOURCE_DIR}/include/boost_1_60_0")
