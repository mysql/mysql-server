...
} views[] =
{
  ...
  { "table_info",
    ...
    " CASE fragment_count_type"
    " WHEN 4294967295 THEN \"SPECIFIC\""
    " WHEN 4294967294 THEN \"ONE_PER_LDM_PER_NODE\""
    " WHEN 4294967293 THEN \"ONE_PER_LDM_PER_NODE_GROUP\""
    " WHEN 4294967292 THEN \"ONE_PER_NODE\""
    " WHEN 4294967291 THEN \"ONE_PER_NODE_GROUP\""
    " ELSE \"Invalid value\""
    " END AS fragment_count_type,"
