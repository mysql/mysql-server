...
public class DatetimeAsSqlTimestampTypes implements IdBase {

    private int id;
    private Timestamp datetime_not_null_hash;
    private Timestamp datetime_not_null_btree;
    private Timestamp datetime_not_null_both;
    private Timestamp datetime_not_null_none;
    ...
    public Timestamp getDatetime_not_null_hash() {
        return datetime_not_null_hash;
    }
    public void setDatetime_not_null_hash(Timestamp value) {
        this.datetime_not_null_hash = value;
    }

    @Column(name="datetime_not_null_btree")
    public Timestamp getDatetime_not_null_btree() {
        return datetime_not_null_btree;
    }
    public void setDatetime_not_null_btree(Timestamp value) {
        this.datetime_not_null_btree = value;
    }

    @Column(name="datetime_not_null_both")
    public Timestamp getDatetime_not_null_both() {
        return datetime_not_null_both;
    }
    public void setDatetime_not_null_both(Timestamp value) {
        this.datetime_not_null_both = value;
    }

    @Column(name="datetime_not_null_none")
    public Timestamp getDatetime_not_null_none() {
        return datetime_not_null_none;
    }
    public void setDatetime_not_null_none(Timestamp value) {
