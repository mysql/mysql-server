...
public class GreaterEqualsNode extends BinaryOperatorNode {

    public GreaterEqualsNode(Token token) {
        super(token);
    }

    public GreaterEqualsNode(GreaterEqualsNode greaterEqualsNode) {
        super(greaterEqualsNode);
    }

    @Override
    public GreaterEqualsNode dupNode() {
