...
function getConfigurationFile(process) {
    ...
    if (ptype == "ndb_mgmd") {
        ...
        // FIXME: OK? NOT!
        //addln(configFile, "nodefaults=on");
    ...
    if (ptype.getValue("name") != "api") {
        ...
        if (ptype.getValue("name") == "ndb_mgmd") {
            startupCommand.html.optionString +="<td>--initial</td></tr>" +
                ...
                mcc.util.unixPath(datadir) + "</td></tr>" +
                "<tr><td></td><td>--config-file=" + mcc.util.unixPath(datadir) + 
            ...
            startupCommand.msg.params = {
                ...
                param: [
                    ...
                    {name: "--config-dir", val: mcc.util.unixPath(datadir)},
                    {name: "--config-file", val: mcc.util.unixPath(datadir + "config.ini")}
                ]
            };
            ...
            startupCommand.html.optionString += 
            "<td>--defaults-file=" + datadir + "my.cnf</td></tr>";
            ...
            startupCommand.msg.params = {
                sep: " ",
                param: [
                    {name: "--defaults-file", val: mcc.util.unixPath(datadir)+"my.cnf"}
                ]
            };
                ...
                startupCommands.push({
                    html: {
                        ...
                        optionString: "<tr><td><b>Options</b></td>" +
                            ...
                            "<tr><td></td><td>--lc-messages-dir=" + mcc.util.unixPath(langdir) + "</td></tr>" +
                            "<tr><td></td><td>--bootstrap" + "</td></tr>" +
                            "<tr><td></td><td>--basedir=" + mcc.util.unixPath(basedir) + "</td></tr>" +
                            "<tr><td></td><td>--datadir=" + mcc.util.unixPath(datadir) + "</td></tr>" +
                            "<tr><td></td><td>--tmpdir=" + mcc.util.unixPath(tmpdir) + "</td></tr>" +
                    ...
                    msg: {
                        ...
                        params: {
                            ...
                            param: [
                                ...
                                {name: "--lc-messages-dir", val: mcc.util.unixPath(langdir)},
                                {name: "--bootstrap"},
