...
var udebug = unified_debug.getLogger("integraltypes/QueryIndexScan.js");
...
var q1 = {p1: 4, p2: 6, expected: [4, 5, 6], queryType: 2, ordered: false, predicate: function(qdt) {
  return qdt.tint.ge(qdt.param('p1')).and(qdt.tint.le(qdt.param('p2')));
}};

var q2 = {p1: 3, p2: 7, expected: [4, 5, 6], queryType: 2, ordered: false, predicate: function(qdt) {
  return qdt.tint.gt(qdt.param('p1')).and(qdt.tint.lt(qdt.param('p2')));
}};
