...
#include "myapi.hpp"
#include "myapi_wrapper.hpp"

// libraries
#include "helpers.hpp"
#include "jtie.hpp"

#define JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION 1
...
#ifndef JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
    return gcall_fr< ttrait_int32, &A::f0s >(env, cls);
#else
    return gcall_fr< ttrait_int32, &MyApiWrapper::A__f0s >(env, cls);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
Java_myjapi_A_h0(JNIEnv * env, jclass cls)
{
    ...
    gcall_fv< &h0 >(env, cls);
#else
    gcall_fv< &MyApiWrapper::A__h0 >(env, cls);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    gcall_fv< ttrait_int8, &MyApiWrapper::A__h1 >(env, cls, p0);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    gcall_fv< ttrait_int8, ttrait_int16, &MyApiWrapper::A__h2 >(env, cls, p0, p1);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    gcall_fv< ttrait_int8, ttrait_int16, ttrait_int32, &MyApiWrapper::A__h3 >(env, cls, p0, p1, p2);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_int32, &MyApiWrapper::A__h0r >(env, cls);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_int32, ttrait_int8, &MyApiWrapper::A__h1r >(env, cls, p0);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_int32, ttrait_int8, ttrait_int16, &MyApiWrapper::A__h2r >(env, cls, p0, p1);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_int32, ttrait_int8, ttrait_int16, ttrait_int32, &MyApiWrapper::A__h3r >(env, cls, p0, p1, p2);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_C0_C0E_iv, &MyApiWrapper::C0__deliver_C0E1 >(env, cls);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    gcall_fv< ttrait_C0_C0E_iv, &MyApiWrapper::C0__take_C0E1 >(env, cls, p0);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    return gcall_fr< ttrait_C0_C0E_c_iv, &MyApiWrapper::C0__deliver_C0E1c >(env, cls);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
...
#else
    gcall_fv< ttrait_C0_C0E_c_iv, &MyApiWrapper::C0__take_C0E1c >(env, cls, p0);
#endif // JTIE_USE_WRAPPED_VARIANT_FOR_MEMBER_FUNCTION
}
