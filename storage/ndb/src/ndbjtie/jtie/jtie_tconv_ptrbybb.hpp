...
typedef ttrait< jobject, const void *, _jtie_j_n_ByteBufferMapper< _jtie_j_n_BoundedByteBuffer< 1 > > * > ttrait_void_1cp_bb;
typedef ttrait< jobject, void *, _jtie_j_n_ByteBufferMapper< _jtie_j_n_BoundedByteBuffer< 1 > > * > ttrait_void_1p_bb;
typedef ttrait< jobject, const void * const, _jtie_j_n_ByteBufferMapper< _jtie_j_n_BoundedByteBuffer< 1 > > * > ttrait_void_1cpc_bb;
typedef ttrait< jobject, void * const, _jtie_j_n_ByteBufferMapper< _jtie_j_n_BoundedByteBuffer< 1 > > * > ttrait_void_1pc_bb;
#endif
