...
#else
  return gcall_fr<ttrait_char_cp_jutf8null, ttrait_c_m_n_m_CharsetMap_cr,
                  ttrait_int, &MysqlUtilsWrapper::CharsetMap__getName>(
      env, NULL, obj, p0);
...
#else
  return gcall_fr<ttrait_char_cp_jutf8null, ttrait_c_m_n_m_CharsetMap_cr,
                  ttrait_int, &MysqlUtilsWrapper::CharsetMap__getMysqlName>(
      env, NULL, obj, p0);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
JNIEXPORT jint JNICALL Java_com_mysql_ndbjtie_mysql_CharsetMap_getCharsetNumber(
  ...
  return gcall_mfr<ttrait_c_m_n_m_CharsetMap_ct, ttrait_int,
      ...
      env, obj, p0);
#else
  return gcall_fr<ttrait_int, ttrait_c_m_n_m_CharsetMap_cr,
                  ttrait_char_cp_jutf8null,
                  &MysqlUtilsWrapper::CharsetMap__getCharsetNumber>(env, NULL,
                                                                    obj, p0);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  return gcall_fr<ttrait_int, ttrait_c_m_n_m_CharsetMap_cr,
                  &MysqlUtilsWrapper::CharsetMap__getUTF8CharsetNumber>(
      env, NULL, obj);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  return gcall_fr<ttrait_int, ttrait_c_m_n_m_CharsetMap_cr,
                  &MysqlUtilsWrapper::CharsetMap__getUTF16CharsetNumber>(
      env, NULL, obj);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  return gcall_fr<ttrait_bool_1cp_a, ttrait_c_m_n_m_CharsetMap_cr, ttrait_int,
                  &MysqlUtilsWrapper::CharsetMap__isMultibyte>(env, NULL, jobj,
                                                               p0);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  return gcall_fr<ttrait_c_m_n_m_CharsetMap_RecodeStatus_iv /*_enum_*/,
                  ttrait_c_m_n_m_CharsetMap_cr, ttrait_Int32_2p_a, ttrait_int,
                  ttrait_int, ttrait_void_0cp_bb, ttrait_void_0p_bb,
                  &MysqlUtilsWrapper::CharsetMap__recode>(env, NULL, obj, p0,
                                                          p1, p2, p3, p4);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
JNIEXPORT jint JNICALL Java_com_mysql_ndbjtie_mysql_Utils_decimal_1str2bin(
  ...
  return gcall_fr<ttrait_int, ttrait_char_0cp_bb, ttrait_int, ttrait_int,
                  ttrait_int, ttrait_void_0p_bb, ttrait_int,
                  &MysqlUtilsWrapper::decimal_str2bin>(env, cls, p0, p1, p2, p3,
                                                       p4, p5);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
JNIEXPORT jint JNICALL Java_com_mysql_ndbjtie_mysql_Utils_decimal_1bin2str(
  ...
  return gcall_fr<ttrait_int, ttrait_void_0cp_bb, ttrait_int, ttrait_int,
                  ttrait_int, ttrait_char_0p_bb, ttrait_int,
                  &MysqlUtilsWrapper::decimal_bin2str>(env, cls, p0, p1, p2, p3,
                                                       p4, p5);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  gcall_fv<ttrait_char_cp_jutf8null, &MysqlUtilsWrapper::dbugPush>(env, cls,
                                                                   p0);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
#else
  return gcall_fr<ttrait_char_cp_jutf8null, ttrait_char_0p_bb, ttrait_int,
                  &MysqlUtilsWrapper::dbugExplain>(env, cls, p0, p1);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
...
JNIEXPORT void JNICALL Java_com_mysql_ndbjtie_mysql_Utils_dbugPrint(
  ...
  gcall_fv<ttrait_char_cp_jutf8null, ttrait_char_cp_jutf8null, &::dbugPrint>(
      env, cls, p0, p1);
#else
  gcall_fv<ttrait_char_cp_jutf8null, ttrait_char_cp_jutf8null,
           &MysqlUtilsWrapper::dbugPrint>(env, cls, p0, p1);
#endif  // NDBJTIE_USE_WRAPPED_VARIANT_FOR_FUNCTION
}
