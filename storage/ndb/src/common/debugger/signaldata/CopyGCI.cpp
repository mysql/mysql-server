...
static void print(char *buf, size_t buf_len, CopyGCIReq::CopyReason r) {
  switch (r) {
...
bool printCOPY_GCI_REQ(FILE *output, const Uint32 *theData, Uint32 len,
                       Uint16 /*recBlockNo*/) {
