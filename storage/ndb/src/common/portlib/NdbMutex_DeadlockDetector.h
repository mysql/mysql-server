...
struct ndb_mutex_state {
  struct nmdd_mask
      m_locked_before_mask; /* mutexes held when locking this mutex */
  struct nmdd_mutex_array
      m_locked_before_list; /* mutexes held when locking this mutex */

  struct nmdd_mutex_array
      m_locked_after_list; /* mutexes locked when holding this mutex*/
