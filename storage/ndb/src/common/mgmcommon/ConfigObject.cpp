...
void ConfigObject::createSections(Uint32 num_sections) {
...
ConfigSection *ConfigObject::openSection(Uint32 section_type,
                                         Uint32 index) const {
...
void ConfigObject::closeSection() { m_curr_cfg_section = nullptr; }

bool ConfigObject::set(ConfigSection *curr_section, ConfigSection::Entry &entry,
                       bool free_string) {
...
Uint32 ConfigObject::getNextEntry(Uint32 key,
                                  ConfigSection::Entry *in_entry) const {
...
bool ConfigObject::get(ConfigSection *curr_section, Uint32 key,
...
int ConfigObject::get_error_code() const { return (int)m_error_code; }

void ConfigObject::print_error_code() const {
  g_eventLogger->info("ConfigObject::m_error_code = %u", m_error_code);
}

bool ConfigObject::unpack_v1(const Uint32 *src, Uint32 len) {
  m_error_code = 0;
  /**
  ...
  while (end - data > 4) {
    ...
    section_type = false;
    DEB_UNPACK_V1(("type: %u, key: %u, section: %u", get_old_type(tmp),
                   get_old_key(tmp), get_old_section(tmp)));
    switch (entry.m_type) {
      case ConfigSection::SectionTypeId: {
        section_type = true;
      ...
      case ConfigSection::StringTypeId: {
        ...
        entry.m_string = data;
        DEB_UNPACK_V1(("StringType(%p): %s, strlen: %u", entry.m_string,
                       entry.m_string, s_len2));
...
void ConfigObject::remove_pointer_sections() {
  Uint32 num_sections = 0;
...
bool ConfigObject::commitConfig(bool only_sort) {
  /* 7) above */
  for (Uint32 i = 0; i < m_num_sections; i++) {
...
void ConfigObject::create_default_sections() {
...
bool ConfigObject::begin() { return true; }

bool ConfigObject::read_v2_header_info(const Uint32 **data) {
  ...
  m_num_node_sections = m_num_data_nodes + m_num_api_nodes + m_num_mgm_nodes;
  if (v2 != 2) {
    /**
...
bool ConfigObject::unpack_default_sections(const Uint32 **data) {
 ...
 */
bool ConfigObject::unpack_v2(const Uint32 *src, Uint32 len) {
...
void ConfigObject::create_v1_header_section(Uint32 **v1_ptr,
  ...
  Uint32 num_early_node_sections = m_num_api_nodes + m_num_mgm_nodes;
  {
    ConfigSection::create_v1_entry_key(v1_ptr, ConfigSection::SectionTypeId,
...
void ConfigObject::create_v1_node_header_section(Uint32 **v1_ptr,
  ...
  for (Uint32 i = 0; i < num_non_data_nodes; i++) {
    ConfigSection::create_v1_entry_key(v1_ptr, ConfigSection::IntTypeId, i, 1);
  ...
  for (Uint32 i = 0; i < num_data_nodes; i++) {
    ConfigSection::create_v1_entry_key(v1_ptr, ConfigSection::IntTypeId,
                                       num_non_data_nodes + i, 1);
    Uint32 section_value = 5 + num_non_data_nodes + m_num_comm_sections + i;
    section_value <<= OLD_KP_SECTION_SHIFT;
    ConfigSection::create_int_value(v1_ptr, section_value);
  }
  curr_section = 2;
...
void ConfigObject::create_v1_node_specific_sections(
    Uint32 **v1_ptr, ConfigSection::SectionType sect_type,
    Uint32 &curr_section) const {
  for (Uint32 i = 0; i < m_num_sections; i++) {
    ConfigSection *cs = m_cfg_sections[i];
...
void ConfigObject::create_v1_api_node_sections(Uint32 **v1_ptr,
                                               Uint32 &curr_section) const {
  create_v1_node_specific_sections(v1_ptr, ConfigSection::ApiNodeTypeId,
                                   curr_section);
}

void ConfigObject::create_v1_mgm_node_sections(Uint32 **v1_ptr,
                                               Uint32 &curr_section) const {
  create_v1_node_specific_sections(v1_ptr, ConfigSection::MgmNodeTypeId,
                                   curr_section);
}
...
void ConfigObject::create_v1_system_header_section(Uint32 **v1_ptr,
                                                   Uint32 &curr_section) const {
  {
    ConfigSection::create_v1_entry_key(v1_ptr, ConfigSection::IntTypeId, 0,
                                       curr_section);
...
void ConfigObject::create_v1_comm_header_section(Uint32 **v1_ptr,
                                                 Uint32 &curr_section) const {
  for (Uint32 i = 0; i < m_num_comm_sections; i++) {
    ConfigSection::create_v1_entry_key(v1_ptr, ConfigSection::IntTypeId, i,
                                       curr_section);
...
void ConfigObject::create_v1_comm_specific_sections(
    Uint32 **v1_ptr, ConfigSection::SectionType sect_type,
    Uint32 &curr_section) const {
...
void ConfigObject::create_v1_comm_sections(Uint32 **v1_ptr,
                                           Uint32 &curr_section) const {
  create_v1_comm_specific_sections(v1_ptr, ConfigSection::DataNodeTypeId,
                                   curr_section);
  create_v1_comm_specific_sections(v1_ptr, ConfigSection::ApiNodeTypeId,
                                   curr_section);
  create_v1_comm_specific_sections(v1_ptr, ConfigSection::MgmNodeTypeId,
                                   curr_section);
}

void ConfigObject::create_v1_data_node_sections(Uint32 **v1_ptr,
                                                Uint32 &curr_section) const {
  create_v1_node_specific_sections(v1_ptr, ConfigSection::DataNodeTypeId,
                                   curr_section);
}
...
void ConfigObject::pack_v1(Uint32 *packed_v1_ptr, Uint32 len) const {
...
void ConfigObject::create_v2_header_section(Uint32 **v2_ptr, Uint32 tot_len,
                                            Uint32 num_comm_sections) const {
  ConfigSection::create_int_value(v2_ptr, tot_len);
  ConfigSection::create_int_value(v2_ptr,
                                  2);  // Version 2 of configuration binary
...
void ConfigObject::create_empty_default_trp_section(Uint32 **v2_ptr,
                                                    Uint32 type) const {
...
Uint32 ConfigObject::get_num_comm_sections(Uint32 node_id) const {
...
Uint32 ConfigObject::get_v2_packed_size(Uint32 node_id) const {
  ...
  for (Uint32 i = 0; i < m_num_comm_sections; i++) {
    ConfigSection *cs = m_comm_sections[i];
    if (node_id == 0 || cs->get_first_node_id() == node_id ||
        cs->get_second_node_id() == node_id) {
...
void ConfigObject::pack_v2(Uint32 *packed_v2_ptr, Uint32 len,
...
static bool compare_node_sections(ConfigSection *first, ConfigSection *second) {
...
static bool compare_comm_sections(ConfigSection *first, ConfigSection *second) {
  if (first == second) return false;
...
bool ConfigObject::build_arrays(bool only_sort) {
  if (!only_sort) {
    Uint32 num_nodes = 0;
    Uint32 num_comm_sections = 0;
  ...
  std::sort(m_node_sections.begin(), m_node_sections.end(),
            compare_node_sections);

  m_comm_sections.shrink_to_fit();
  std::sort(m_comm_sections.begin(), m_comm_sections.end(),
