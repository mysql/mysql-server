...
class Dbtc : public SimulatedBlock {
  ...
  */
  ...
  /* **************************************** */
  struct TcIndexData {
    TcIndexData() : indexState(IS_OFFLINE) {}
...
#define NUM_FRAG_LOCATIONS_IN_ARRAY 32
 ...
 private:
  ...
  Uint32 sendCommitLqh(Signal *signal, TcConnectRecord *regTcPtr,
                       ApiConnectRecord *regApiPtr);
  ...
  void checkWaitFireTrigConfDone(Signal *, Ptr<ApiConnectRecord>);
...
#define TRANSID_FAIL_HASH_SIZE 1024
  ...
  bool findApiConnectFail(Signal *signal, Uint32 transid1, Uint32 transid2,
                          ApiConnectRecordPtr &apiConnectptr);
  void initApiConnectFail(Signal *signal, Uint32 transid1, Uint32 transid2,
  ...
  void abortTransFromTrigger(Signal *signal, ApiConnectRecordPtr transPtr,
                             Uint32 error);
