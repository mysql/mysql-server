...
Dbdict::execCREATE_FRAGMENTATION_REQ(Signal* signal)
{
  ...
  LocalArenaPoolImpl<OpSectionSegment> op_sec_pool(op_ptr.p->m_trans_ptr.p->m_arena,c_opSectionBufferPool);
                         ...
                         SectionHandle& handle, ErrorInfo& error)
{
  ...
  // add attribute stuff
  {
    ...
    list.first(attrPtr);
    Uint32 i = 0;
    LocalArenaPoolImpl<OpSectionSegment> op_sec_pool(trans_ptr.p->m_arena, c_opSectionBufferPool);
                         ...
                         SegmentedSectionPtr ss_ptr)
{
  ...
  LocalArenaPoolImpl<OpSectionSegment> op_sec_pool(op_ptr.p->m_trans_ptr.p->m_arena,
                                 c_opSectionBufferPool);
