...
typedef Ptr<Fragoperrec> FragoperrecPtr;
  ...
  void printPtr(int idx, const Ptr<Dbtup::Page> &ptr);
  void printPtr(int idx, const Ptr<Dbtup::Page_request> &ptr);
  void printPtr(const char *msg, int idx, const Ptr<Dbtup::Extent_info> &ptr);
