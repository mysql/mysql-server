...
struct File_formats 
{
  ...
  struct Datafile 
  {
    ...
    struct Extent_page
    {
      ...
      Extent_data* get_extent_data(Uint32 extent_no,
                                   Uint32 extent_size,
                                   bool v2);
      ...
      Uint32 *get_next_free_extent(Uint32 extent_no,
                                   Uint32 extent_size,
                                   bool v2);
      Uint32 *get_create_table_version(Uint32 extent_no,
                                       Uint32 extent_size,
                                       bool v2);
    };
                                            ...
                                            bool v2)
{
  if (v2)
  {
    return EXTENT_HEADER_FIXED_WORDS_v2 + 
      ((extent_size_in_pages * EXTENT_HEADER_BITMASK_BITS_PER_PAGE_v2 + 31) >> 5);
  }
  else
  {
...
inline Uint32
File_formats::Datafile::extent_page_words(bool v2)
{
  if (v2)
  {
...
File_formats::Datafile::Extent_page::get_header(Uint32 no,
                                                Uint32 extent_size,
                                                bool v2)
{
  if (v2)
...
inline
File_formats::Datafile::Extent_header_v2*
File_formats::Datafile::Extent_page_v2::get_header_v2(Uint32 no, Uint32 extent_size)
{
  Uint32 * tmp = (Uint32*)m_extents;
...
inline
Uint32
File_formats::Datafile::Extent_data::get_free_bits(Uint32 page) const
{
...
inline
Uint32
File_formats::Datafile::Extent_data::get_free_word_offset(Uint32 page) const
{
  return page >> 3;
}
...
inline
void
File_formats::Datafile::Extent_data::update_free_bits(Uint32 page, 
                                                      Uint32 bit)
{
...
inline
bool
File_formats::Datafile::Extent_data::check_free(Uint32 extent_size) const 
{
...
inline
File_formats::Datafile::Extent_data*
...
inline
Uint32*
File_formats::Datafile::Extent_page::get_table_id(Uint32 no,
                                                  Uint32 extent_size,
                                                  bool v2)
{
  Uint32 *ret_data;
...
inline
Uint32*
File_formats::Datafile::Extent_page::get_fragment_id(Uint32 no,
                                                     Uint32 extent_size,
                                                     bool v2)
{
  Uint32 *ret_data;
...
inline
Uint32*
File_formats::Datafile::Extent_page::get_next_free_extent(Uint32 no,
                                                     Uint32 extent_size,
                                                     bool v2)
{
...
inline
Uint32*
File_formats::Datafile::Extent_page::get_create_table_version(Uint32 no,
                                                     Uint32 extent_size,
                                                     bool v2)
{
  Uint32 *ret_data;
