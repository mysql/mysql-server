...
bool opt_core;
static int opt_daemon, opt_no_daemon, opt_foreground, opt_initialstart,
    opt_verbose;
...
static struct my_option my_long_options[] = {
    ...
    {"initial", NDB_OPT_NOSHORT,
     ...
     &opt_initial, nullptr, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, nullptr, 0,
     nullptr},
    {"nostart", 'n',
     "Don't start ndbd immediately. Ndbd will await command from ndb_mgmd",
     &opt_no_start, nullptr, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, nullptr, 0,
     nullptr},
    {"daemon", 'd', "Start ndbd as daemon (default)", &opt_daemon, nullptr,
     nullptr, GET_BOOL, NO_ARG, 1, 0, 0, nullptr, 0, nullptr},
    {"nodaemon", NDB_OPT_NOSHORT,
     "Do not start ndbd as daemon, provided for testing purposes",
     &opt_no_daemon, nullptr, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, nullptr, 0,
     nullptr},
    {"foreground", NDB_OPT_NOSHORT,
     "Run real ndbd in foreground, provided for debugging purposes"
     " (implies --nodaemon)",
     &opt_foreground, nullptr, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, nullptr, 0,
     nullptr},
    ...
    {"verbose", 'v', "Write more log messages", &opt_verbose, nullptr, nullptr,
     GET_BOOL, NO_ARG, 0, 0, 1, nullptr, 0, nullptr},
    {"report-fd", 256, "INTERNAL: fd where to write extra shutdown status",
     &opt_report_fd, nullptr, nullptr, GET_UINT, REQUIRED_ARG, 0, 0, INT_MAX,
     nullptr, 0, nullptr},
    {"filesystem-password", NDB_OPT_NOSHORT, "Filesystem password", nullptr,
     nullptr, nullptr, GET_PASSWORD, OPT_ARG, 0, 0, 0, nullptr, 0,
     &opt_filesystem_password},
    {"filesystem-password-from-stdin", NDB_OPT_NOSHORT,
     "Read encryption/decryption password from stdin",
     &opt_filesystem_password_from_stdin.opt_value, nullptr, nullptr, GET_BOOL,
     NO_ARG, 0, 0, 0, nullptr, 0, &opt_filesystem_password_from_stdin},
    {"allocated-nodeid", 256, "INTERNAL: nodeid allocated by angel process",
     &opt_allocated_nodeid, nullptr, nullptr, GET_UINT, REQUIRED_ARG, 0, 0,
...
int real_main(int argc, char **argv) {
  ...
  if (opt_verbose) g_eventLogger->enable(Logger::LL_DEBUG);
  ...
  if (opt_foreground || opt_allocated_nodeid || opt_report_fd) {
    /**
      This is where we start running the real data node process after
      reading options. This function will never return.
    */
    ndbd_run(opt_foreground, opt_report_fd, opt_ndb_connectstring,
             opt_ndb_nodeid, opt_bind_address, opt_no_start, opt_initial,
             opt_initialstart, opt_allocated_nodeid, opt_connect_retries,
             opt_connect_retry_delay, opt_logbuffer_size, opt_tls_search_path,
             opt_mgm_tls);
  }
  ...
  */
  angel_run(progname, original_args, opt_ndb_connectstring, opt_ndb_nodeid,
            opt_bind_address, opt_initial, opt_no_start, opt_daemon,
            opt_connect_retries, opt_connect_retry_delay, opt_tls_search_path,
            opt_mgm_tls);
...
int main(int argc, char **argv) {
  ...
  int rc = ndb_daemon_init(argc, argv, real_main, angel_stop, "ndbd",
