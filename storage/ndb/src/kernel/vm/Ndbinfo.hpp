...
public:
  ...
  enum counter_id {
    ...
    READS_RECEIVED_COUNTER = 11,
    LOCAL_READS_SENT_COUNTER = 12,
    REMOTE_READS_SENT_COUNTER = 13,
    TABLE_SCANS_RECEIVED_COUNTER = 14,
    LOCAL_TABLE_SCANS_SENT_COUNTER = 15,
    RANGE_SCANS_RECEIVED_COUNTER = 16,
    LOCAL_RANGE_SCANS_SENT_COUNTER = 17
  };
