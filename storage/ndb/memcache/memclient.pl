...
### My::Memcache.pm copied from mysql-test/lib on 8 Feb. 2013 & then modified
...
###
###  $mc->get(key)                      returns value
###  $mc->get(@keys)                    Multi-get; use with next_result() 
###  $mc->next_result()                   -- fetch results after a get() 
### 
