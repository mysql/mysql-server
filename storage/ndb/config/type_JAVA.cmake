...
MACRO(CREATE_JAR)
  ...
  ADD_CUSTOM_COMMAND(
    ...
    COMMAND echo "${JAVA_COMPILE} 
      -d ${CMAKE_CURRENT_SOURCE_DIR}/${CLASS_DIR}  
      -classpath ${ARG_CLASSPATH} ${JAVA_FILES}"

    COMMAND ${JAVA_COMPILE}
      ARGS -d ${CMAKE_CURRENT_SOURCE_DIR}/${CLASS_DIR}
      ARGS -classpath "${ARG_CLASSPATH}" ${JAVA_FILES}

    COMMAND echo "${CMAKE_COMMAND}
      ARGS -E chdir ${CMAKE_CURRENT_BINARY_DIR}
      ${JAVA_ARCHIVE} cfv ${JAR_DIR}/${TARGET} -C ${CLASS_DIR} ."
