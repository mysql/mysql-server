...
void
NdbapiTwsDriver::initOperations() {
}

void
NdbapiTwsDriver::closeOperations() {
}

// XXX call buffer init/close from elsewhere
void
NdbapiTwsDriver::runOperations(int nOps) {
...
void
NdbapiTwsDriver::initNdbapiBuffers(int nOps) {
...
void
NdbapiTwsDriver::closeNdbapiBuffers(int nOps) {
    assert(bb != NULL);
    assert(ra != NULL);
