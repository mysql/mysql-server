...
class Config {
 public:
  ...
  void print(const char *section_filter = nullptr, NodeId nodeid_filter = 0,
             const char *param_filter = nullptr, NdbOut &out = ndbout) const;
 ...
 private:
  bool setValue(Uint32 section, Uint32 section_no, Uint32 id, Uint32 new_val);
  bool setValue(Uint32 section, Uint32 section_no, Uint32 id,
                const char *new_val);
