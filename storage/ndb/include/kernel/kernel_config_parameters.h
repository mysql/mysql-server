...
#define CFG_TC_API_CONNECT_FAIL (PRIVATE_BASE + 47)
#define CFG_TC_TRIGGER_OPS    (PRIVATE_BASE + 48)
#define CFG_TC_INDEX_OPS      (PRIVATE_BASE + 49)
#define CFG_TC_TRANS_BUFFER   (PRIVATE_BASE + 50)
*/
...
#define CFG_TC_TARGET_CONNECT_RECORD (PRIVATE_BASE + 49)      // =MaxNoOfConcOp+16+MaxNoOfConcTrans
#define CFG_TC_TARGET_TO_CONNECT_RECORD (PRIVATE_BASE + 50) // =MaxNoOfConcOp
...
#define CFG_TC_TARGET_API_CONNECT_RECORD (PRIVATE_BASE + 54)      // =MaxNoOfConcTrans
#define CFG_TC_TARGET_TO_API_CONNECT_RECORD (PRIVATE_BASE + 55) // =MaxNoOfConcTrans
