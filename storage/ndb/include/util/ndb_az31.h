...
class ndb_az31 {
 public:
  ...
  int set_data_size(Uint64 data_size) {
    m_data_size = data_size;
    m_have_data_size = true;
    return 0;
  }
  int set_data_crc32(Uint32 data_crc32) {
  ...
  int get_data_size(Uint64 *data_size) const {
    if (!m_have_data_size) return -1;
    *data_size = m_data_size;
    return 0;
  }
  int get_data_crc32(Uint32 *data_crc32) const {
    if (!m_have_data_crc32) return -1;
    *data_crc32 = m_data_crc32;
    return 0;
  }
