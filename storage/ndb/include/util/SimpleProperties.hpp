...
class SimpleProperties {
  ...
  */
  ...
  static UnpackStatus unpack(class Reader &, void *struct_dst,
  ...
  */
  ...
  static UnpackStatus pack(class Writer &, const void *struct_src,
                           const SP2StructMapping[], Uint32 mapSz,
...
inline Uint32 SimplePropertiesSectionReader::getSize() const { return m_len; }
