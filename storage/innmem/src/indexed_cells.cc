...
/** @file storage/innmem/src/indexed_cells.cc
InnMEM Indexed Cells implementation. */
...
#include "innmem/row.h"     /* innmem::Row, innmem::Rows, innmem::Rows_cursor */
...
Cell Indexed_cells::cell(size_t i, const Index& index) const {
  ...
  /** Generate a cell from a `innmem::Row` object with a possibly reduced
