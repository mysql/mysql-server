...
/** @file storage/innmem/src/test.cc
...
#ifdef ALSO_DO_READS
  std::array<unsigned char[sizeof(innmem::Storage::Iterator)], n_rows>
      positions;
#endif /* ALSO_DO_READS */
...
void Test::performance() {
  for (int i = 0; i < 1; ++i) {
    {
      Chrono chrono("innmem write only");
