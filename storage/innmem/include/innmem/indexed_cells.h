...
/** @file storage/innmem/include/innmem/indexed_cells.h
InnMEM Indexed Cells declaration. */

#ifndef INNMEM_INDEXED_CELLS_H
#define INNMEM_INDEXED_CELLS_H
...
class Indexed_cells {
 ...
 private:
   ...
   * have references to a `innmem::Row` object. */
