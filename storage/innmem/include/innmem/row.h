...
/** @file storage/innmem/include/innmem/row.h
InnMEM Row declarations. */

/** @page PAGE_INNMEM_ROW_FORMAT Row format
...
@section INNMEM_FORMAT InnMEM format

We introduce a new format, lets call it InnMEM format, that fulfills the
following:
...
A row in the InnMEM format consists of a set of Cells stored in one buffer,
