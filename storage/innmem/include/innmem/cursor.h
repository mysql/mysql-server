...
/** @file storage/innmem/include/innmem/cursor.h
InnMEM index cursor. */

#ifndef INNMEM_CURSOR_H
#define INNMEM_CURSOR_H

#include "innmem/column.h"        /* innmem::Columns */
...
#include "innmem/storage.h"       /* innmem::Storage::Element */
