...
/** @file storage/innmem/include/innmem/cell.h
InnMEM Cell declaration. */

#ifndef INNMEM_CELL_H
#define INNMEM_CELL_H

#include <algorithm> /* std::min */
#include <cstdint>   /* uint32_t */

#include "field.h"                 /* Field */
#include "innmem/indexed_column.h" /* innmem::Indexed_column */
