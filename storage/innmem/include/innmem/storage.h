...
/** @file storage/innmem/include/innmem/storage.h
InnMEM Storage. */

#ifndef INNMEM_STORAGE_H
#define INNMEM_STORAGE_H

#include <cstddef> /* size_t */
#include <utility> /* std::move() */

#include "innmem/allocator.h" /* innmem::Allocator */
#include "innmem/constants.h" /* innmem::STORAGE_PAGE_SIZE */
