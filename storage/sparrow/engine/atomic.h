...
#ifndef _engine_atomic_h_
#define _engine_atomic_h_
...
#elif defined(_WIN32)
	static uint32_t add32(volatile uint32_t* target, const int32_t delta) {
		return _InterlockedExchangeAdd(reinterpret_cast<volatile long*>(target), delta) + delta;
	}
...
#endif /* #ifndef _engine_atomic_h_ */
