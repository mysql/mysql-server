...
// STATIC
size_t LZJB::compress(uint8_t* s_start, uint8_t* d_start, size_t s_len, size_t d_len) {
	uint8_t* src = s_start;
	uint8_t* dst = d_start;
	uint8_t* cpy;
	uint8_t* copymap = 0;
...
// STATIC
int LZJB::decompress(uint8_t* s_start, uint8_t* d_start, size_t s_len, size_t d_len) {
	uint8_t* src = s_start;
	uint8_t* dst = d_start;
