...
#ifndef TABLE_EES_BY_USER_BY_ERROR_H
#define TABLE_EES_BY_USER_BY_ERROR_H

/**
  @file storage/perfschema/table_ees_by_user_by_error.h
...
class PFS_index_ees_by_user_by_error : public PFS_engine_index
{
public:
  PFS_index_ees_by_user_by_error()
    : PFS_engine_index(&m_key_1, &m_key_2),
    m_key_1("USER"), m_key_2("ERROR_NUMBER")
  {}
...
*/
struct row_ees_by_user_by_error
{
  /** Column USER */
  PFS_user_row m_user;
...
*/
struct pos_ees_by_user_by_error
...
class table_ees_by_user_by_error : public PFS_engine_table
{
public:
  /** Table share */
...
protected:
  void make_row(PFS_user *user, int error_index);
...
private:
  ...
  /** Current row. */
  row_ees_by_user_by_error m_row;
  /** True is the current row exists. */
  bool m_row_exists;
  /** Current position. */
  pos_ees_by_user_by_error m_pos;
  /** Next position. */
  pos_ees_by_user_by_error m_next_pos;

  PFS_index_ees_by_user_by_error *m_opened_index;
};
