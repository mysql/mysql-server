...
{
public:
  All_THD_visitor_adapter(PFS_connection_visitor *visitor) : m_visitor(visitor)
  {
  }
...
/** Connection iterator */
void
PFS_connection_iterator::visit_global(bool with_hosts,
                                      bool with_users,
                                      bool with_accounts,
                                      bool with_threads,
                                      bool with_THDs,
...
void
PFS_connection_iterator::visit_host(PFS_host *host,
                                    bool with_accounts,
                                    bool with_threads,
                                    bool with_THDs,
                                    PFS_connection_visitor *visitor)
...
void
PFS_connection_iterator::visit_user(PFS_user *user,
                                    bool with_accounts,
                                    bool with_threads,
                                    bool with_THDs,
                                    PFS_connection_visitor *visitor)
...
void
PFS_connection_iterator::visit_account(PFS_account *account,
                                       bool with_threads,
                                       bool with_THDs,
                                       PFS_connection_visitor *visitor)
{
...
void
PFS_connection_iterator::visit_THD(THD *thd, PFS_connection_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
...
void
PFS_instance_iterator::visit_all(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_mutex(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_mutex_classes(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_mutex_instances(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_rwlock(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_rwlock_classes(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_rwlock_instances(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_cond(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_cond_classes(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_cond_instances(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_file(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_file_classes(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_all_file_instances(PFS_instance_visitor *visitor)
{
...
void
PFS_instance_iterator::visit_mutex_instances(PFS_mutex_class *klass,
...
void
PFS_instance_iterator::visit_rwlock_instances(PFS_rwlock_class *klass,
                                              PFS_instance_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
...
void
PFS_instance_iterator::visit_cond_instances(PFS_cond_class *klass,
                                            PFS_instance_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
...
void
PFS_instance_iterator::visit_file_instances(PFS_file_class *klass,
                                            PFS_instance_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
                                              ...
                                              bool visit_class)
{
  ...
  else
  {
    ...
    while (pfs != NULL)
    {
      if (unlikely((pfs->m_class == klass) && (pfs->m_thread_owner == thread)))
      {
        visitor->visit_socket(pfs);
      }
      pfs = it.scan_next();
...
void
PFS_instance_iterator::visit_instances(PFS_instr_class *klass,
                                       PFS_instance_visitor *visitor,
                                       PFS_thread *thread,
                                       bool visit_class)
{
  ...
  case PFS_CLASS_SOCKET:
  {
    ...
    PFS_instance_iterator::visit_socket_instances(
      socket_class, visitor, thread, visit_class);
  }
  break;
  default:
    break;
...
/** Object iterator */
void
PFS_object_iterator::visit_all(PFS_object_visitor *visitor)
{
...
void
PFS_object_iterator::visit_all_tables(PFS_object_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
...
void
PFS_object_iterator::visit_tables(PFS_table_share *share,
...
void
PFS_object_iterator::visit_table_indexes(PFS_table_share *share,
                                         uint index,
                                         PFS_object_visitor *visitor)
{
  DBUG_ASSERT(visitor != NULL);
...
void
PFS_connection_wait_visitor::visit_global()
{
  /*
...
void
PFS_connection_wait_visitor::visit_host(PFS_host *pfs)
{
...
void
PFS_connection_wait_visitor::visit_user(PFS_user *pfs)
{
  const PFS_single_stat *event_name_array;
  event_name_array = pfs->read_instr_class_waits_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_wait_visitor::visit_account(PFS_account *pfs)
{
  const PFS_single_stat *event_name_array;
  event_name_array = pfs->read_instr_class_waits_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_wait_visitor::visit_thread(PFS_thread *pfs)
{
  const PFS_single_stat *event_name_array;
  event_name_array = pfs->read_instr_class_waits_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_all_wait_visitor::visit_global()
{
...
void
PFS_connection_all_wait_visitor::visit_connection_slice(
...
void
PFS_connection_all_wait_visitor::visit_host(PFS_host *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_wait_visitor::visit_user(PFS_user *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_wait_visitor::visit_account(PFS_account *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_wait_visitor::visit_thread(PFS_thread *pfs)
{
  visit_connection_slice(pfs);
}
...
void
PFS_connection_stage_visitor::visit_global()
{
  m_stat.aggregate(&global_instr_class_stages_array[m_index]);
}

void
PFS_connection_stage_visitor::visit_host(PFS_host *pfs)
{
...
void
PFS_connection_stage_visitor::visit_user(PFS_user *pfs)
{
  const PFS_stage_stat *event_name_array;
  event_name_array = pfs->read_instr_class_stages_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_stage_visitor::visit_account(PFS_account *pfs)
{
  const PFS_stage_stat *event_name_array;
  event_name_array = pfs->read_instr_class_stages_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_stage_visitor::visit_thread(PFS_thread *pfs)
{
  const PFS_stage_stat *event_name_array;
  event_name_array = pfs->read_instr_class_stages_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_statement_visitor::visit_global()
{
  m_stat.aggregate(&global_instr_class_statements_array[m_index]);
}

void
PFS_connection_statement_visitor::visit_host(PFS_host *pfs)
{
...
void
PFS_connection_statement_visitor::visit_user(PFS_user *pfs)
{
  const PFS_statement_stat *event_name_array;
  event_name_array = pfs->read_instr_class_statements_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_statement_visitor::visit_account(PFS_account *pfs)
{
  const PFS_statement_stat *event_name_array;
  event_name_array = pfs->read_instr_class_statements_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_statement_visitor::visit_thread(PFS_thread *pfs)
{
  const PFS_statement_stat *event_name_array;
  event_name_array = pfs->read_instr_class_statements_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_all_statement_visitor::visit_global()
{
...
void
PFS_connection_all_statement_visitor::visit_connection_slice(
  PFS_connection_slice *pfs)
{
...
void
PFS_connection_all_statement_visitor::visit_host(PFS_host *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_statement_visitor::visit_user(PFS_user *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_statement_visitor::visit_account(PFS_account *pfs)
{
  visit_connection_slice(pfs);
}

void
PFS_connection_all_statement_visitor::visit_thread(PFS_thread *pfs)
{
  visit_connection_slice(pfs);
}
...
void
PFS_connection_transaction_visitor::visit_global()
{
  m_stat.aggregate(&global_transaction_stat);
}

void
PFS_connection_transaction_visitor::visit_host(PFS_host *pfs)
{
...
void
PFS_connection_transaction_visitor::visit_user(PFS_user *pfs)
{
  const PFS_transaction_stat *event_name_array;
  event_name_array = pfs->read_instr_class_transactions_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_transaction_visitor::visit_account(PFS_account *pfs)
{
  const PFS_transaction_stat *event_name_array;
  event_name_array = pfs->read_instr_class_transactions_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_transaction_visitor::visit_thread(PFS_thread *pfs)
{
  const PFS_transaction_stat *event_name_array;
  event_name_array = pfs->read_instr_class_transactions_stats();
  if (event_name_array != NULL)
...
void
PFS_connection_error_visitor::visit_global()
{
  m_stat.aggregate(global_error_stat.get_stat(m_error_index));
}

void
PFS_connection_error_visitor::visit_host(PFS_host *pfs)
{
...
void
PFS_connection_error_visitor::visit_user(PFS_user *pfs)
{
  const PFS_error_stat *event_name_array;
  event_name_array = pfs->read_instr_class_errors_stats();
...
void
PFS_connection_error_visitor::visit_account(PFS_account *pfs)
{
  const PFS_error_stat *event_name_array;
  event_name_array = pfs->read_instr_class_errors_stats();
...
void
PFS_connection_error_visitor::visit_thread(PFS_thread *pfs)
{
  const PFS_error_stat *event_name_array;
  event_name_array = pfs->read_instr_class_errors_stats();
...
void
PFS_connection_stat_visitor::visit_global()
{
}

void
PFS_connection_stat_visitor::visit_host(PFS_host *pfs)
{
  m_stat.aggregate_disconnected(pfs->m_disconnected_count);
}

void
PFS_connection_stat_visitor::visit_user(PFS_user *pfs)
{
  m_stat.aggregate_disconnected(pfs->m_disconnected_count);
}

void
PFS_connection_stat_visitor::visit_account(PFS_account *pfs)
{
  m_stat.aggregate_disconnected(pfs->m_disconnected_count);
}
...
void
PFS_connection_status_visitor::visit_global()
{
...
void
PFS_connection_status_visitor::visit_host(PFS_host *pfs)
{
  pfs->m_status_stats.aggregate_to(m_status_vars);
}

void
PFS_connection_status_visitor::visit_user(PFS_user *pfs)
{
  pfs->m_status_stats.aggregate_to(m_status_vars);
}

void
PFS_connection_status_visitor::visit_account(PFS_account *pfs)
{
  pfs->m_status_stats.aggregate_to(m_status_vars);
}

void
PFS_connection_status_visitor::visit_thread(PFS_thread *)
{
}

void
PFS_connection_status_visitor::visit_THD(THD *thd)
{
...
void
PFS_instance_wait_visitor::visit_mutex_class(PFS_mutex_class *pfs)
{
  m_stat.aggregate(&pfs->m_mutex_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_rwlock_class(PFS_rwlock_class *pfs)
{
  m_stat.aggregate(&pfs->m_rwlock_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_cond_class(PFS_cond_class *pfs)
{
  m_stat.aggregate(&pfs->m_cond_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_file_class(PFS_file_class *pfs)
{
  pfs->m_file_stat.m_io_stat.sum_waits(&m_stat);
}

void
PFS_instance_wait_visitor::visit_socket_class(PFS_socket_class *pfs)
{
  pfs->m_socket_stat.m_io_stat.sum_waits(&m_stat);
}

void
PFS_instance_wait_visitor::visit_mutex(PFS_mutex *pfs)
{
  m_stat.aggregate(&pfs->m_mutex_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_rwlock(PFS_rwlock *pfs)
{
  m_stat.aggregate(&pfs->m_rwlock_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_cond(PFS_cond *pfs)
{
  m_stat.aggregate(&pfs->m_cond_stat.m_wait_stat);
}

void
PFS_instance_wait_visitor::visit_file(PFS_file *pfs)
{
...
void
PFS_instance_wait_visitor::visit_socket(PFS_socket *pfs)
{
...
void
PFS_object_wait_visitor::visit_global()
{
...
void
PFS_object_wait_visitor::visit_table_share(PFS_table_share *pfs)
{
...
void
PFS_object_wait_visitor::visit_table(PFS_table *pfs)
{
...
void
PFS_table_io_wait_visitor::visit_global()
{
  global_table_io_stat.sum(&m_stat);
}

void
PFS_table_io_wait_visitor::visit_table_share(PFS_table_share *pfs)
{
...
void
PFS_table_io_wait_visitor::visit_table(PFS_table *pfs)
{
  PFS_table_share *safe_share = sanitize_table_share(pfs->m_share);
...
void
PFS_table_io_stat_visitor::visit_table_share(PFS_table_share *pfs)
{
  uint safe_key_count = sanitize_index_count(pfs->m_key_count);
  uint index;
  PFS_table_share_index *index_stat;
...
void
PFS_table_io_stat_visitor::visit_table(PFS_table *pfs)
{
  PFS_table_share *safe_share = sanitize_table_share(pfs->m_share);
...
void
PFS_index_io_stat_visitor::visit_table_share_index(PFS_table_share *pfs,
                                                   uint index)
{
  PFS_table_share_index *index_stat;
...
void
PFS_index_io_stat_visitor::visit_table_index(PFS_table *pfs, uint index)
{
  m_stat.aggregate(&pfs->m_table_stat.m_index_stat[index]);
}
...
void
PFS_table_lock_wait_visitor::visit_global()
{
  global_table_lock_stat.sum(&m_stat);
}

void
PFS_table_lock_wait_visitor::visit_table_share(PFS_table_share *pfs)
{
  pfs->sum_lock(&m_stat);
}

void
PFS_table_lock_wait_visitor::visit_table(PFS_table *pfs)
{
...
void
PFS_table_lock_stat_visitor::visit_table_share(PFS_table_share *pfs)
{
...
void
PFS_table_lock_stat_visitor::visit_table(PFS_table *pfs)
{
...
void
PFS_instance_socket_io_stat_visitor::visit_socket_class(PFS_socket_class *pfs)
{
...
void
PFS_instance_socket_io_stat_visitor::visit_socket(PFS_socket *pfs)
{
  /* Aggregate wait times, event counts and byte counts */
  m_socket_io_stat.aggregate(&pfs->m_socket_stat.m_io_stat);
}
...
void
PFS_instance_file_io_stat_visitor::visit_file_class(PFS_file_class *pfs)
{
  /* Aggregate wait times, event counts and byte counts */
...
void
PFS_instance_file_io_stat_visitor::visit_file(PFS_file *pfs)
{
  /* Aggregate wait times, event counts and byte counts */
  m_file_io_stat.aggregate(&pfs->m_file_stat.m_io_stat);
}
