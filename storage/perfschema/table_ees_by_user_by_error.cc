...
int table_ees_by_user_by_error::delete_all_rows() {
...
ha_rows table_ees_by_user_by_error::get_row_count() {
...
int table_ees_by_user_by_error::rnd_next() {
  PFS_user *user;
...
int table_ees_by_user_by_error::index_next() {
  PFS_user *user;
  bool has_more_user = true;
