...
bool
PFS_index_setup_actors::match(PFS_setup_actor *pfs)
{
  if (m_fields >= 1)
  {
...
int
table_setup_actors::delete_all_rows(void)
{
  return reset_setup_actor();
}

ha_rows
table_setup_actors::get_row_count(void)
{
...
void
table_setup_actors::reset_position(void)
{
  m_pos.m_index = 0;
...
int
table_setup_actors::rnd_pos(const void *pos)
{
  PFS_setup_actor *pfs;
...
int
table_setup_actors::make_row(PFS_setup_actor *pfs)
{
...
int
table_setup_actors::read_row_values(TABLE *table,
                                    unsigned char *,
                                    Field **fields,
                                    bool read_all)
{
...
int
table_setup_actors::update_row_values(TABLE *table,
                                      const unsigned char *,
                                      unsigned char *,
                                      Field **fields)
{
...
int
table_setup_actors::delete_row_values(TABLE *, const unsigned char *, Field **)
{
