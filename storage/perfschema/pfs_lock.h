...
struct pfs_lock
{
  ...
  */
  void
  allocated_to_dirty(pfs_dirty_state *copy_ptr)
  {
  ...
  */
  void
  dirty_to_allocated(const pfs_dirty_state *copy)
  {
  ...
  */
  void
  dirty_to_free(const pfs_dirty_state *copy)
  {
    /* Make sure the record was DIRTY. */
    DBUG_ASSERT((copy->m_version_state & STATE_MASK) == PFS_LOCK_DIRTY);
  ...
  */
  bool
  end_optimistic_lock(const pfs_optimistic_state *copy)
  {
