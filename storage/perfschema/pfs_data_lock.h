...
struct pk_pos_data_lock_wait
{
  ...
  {
    memcpy(m_requesting_engine_lock_id, other->m_requesting_engine_lock_id, sizeof(m_requesting_engine_lock_id));
    m_requesting_engine_lock_id_length= other->m_requesting_engine_lock_id_length;
    memcpy(m_blocking_engine_lock_id, other->m_blocking_engine_lock_id, sizeof(m_blocking_engine_lock_id));
...
public:
  PFS_index_data_locks_by_lock_id()
    ...
    m_key_1("ENGINE_LOCK_ID"), m_key_2("ENGINE")
  {}
...
public:
  PFS_index_data_locks_by_transaction_id()
    : PFS_index_data_locks(&m_key_1, &m_key_2),
    m_key_1("ENGINE_TRANSACTION_ID"), m_key_2("ENGINE")
  {}
...
public:
  PFS_index_data_locks_by_object()
    ...
    m_key_1("OBJECT_SCHEMA"), m_key_2("OBJECT_NAME"),
    m_key_3("PARTITION_NAME"), m_key_4("SUBPARTITION_NAME")
  {}
...
{
public:
  PFS_index_data_lock_waits(PFS_engine_key *key_1,
                            PFS_engine_key *key_2)
    : PFS_engine_index(key_1, key_2)
  {}
...
class PFS_index_data_lock_waits_by_requesting_lock_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_requesting_lock_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("REQUESTING_ENGINE_LOCK_ID"), m_key_2("ENGINE")
  {}
...
class PFS_index_data_lock_waits_by_blocking_lock_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_blocking_lock_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("BLOCKING_ENGINE_LOCK_ID"), m_key_2("ENGINE")
  {}
...
class PFS_index_data_lock_waits_by_requesting_transaction_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_requesting_transaction_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("REQUESTING_ENGINE_TRANSACTION_ID"), m_key_2("ENGINE")
  {}
...
class PFS_index_data_lock_waits_by_blocking_transaction_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_blocking_transaction_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("BLOCKING_ENGINE_TRANSACTION_ID"), m_key_2("ENGINE")
  {}
...
class PFS_index_data_lock_waits_by_requesting_thread_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_requesting_thread_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("REQUESTING_THREAD_ID"), m_key_2("REQUESTING_EVENT_ID")
  {}
...
class PFS_index_data_lock_waits_by_blocking_thread_id : public PFS_index_data_lock_waits
{
public:
  PFS_index_data_lock_waits_by_blocking_thread_id()
    : PFS_index_data_lock_waits(&m_key_1, &m_key_2),
    m_key_1("BLOCKING_THREAD_ID"), m_key_2("BLOCKING_EVENT_ID")
  {}
...
public:
  ...
  virtual bool accept_lock_id(const char *engine_lock_id, size_t engine_lock_id_length);
  virtual bool accept_transaction_id(ulonglong transaction_id);
  virtual bool accept_thread_id_event_id(ulonglong thread_id, ulonglong event_id);
...
public:
  ...
  virtual bool accept_engine(const char *engine, size_t engine_length);
  virtual bool accept_requesting_lock_id(const char *engine_lock_id, size_t engine_lock_id_length);
  virtual bool accept_blocking_lock_id(const char *engine_lock_id, size_t engine_lock_id_length);
  ...
  virtual bool accept_requesting_thread_id_event_id(ulonglong thread_id, ulonglong event_id);
  virtual bool accept_blocking_thread_id_event_id(ulonglong thread_id, ulonglong event_id);
