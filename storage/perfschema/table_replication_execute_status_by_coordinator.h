...
enum enum_rpl_coordinator_field_names {
  COORDINATOR_THREAD_ID= 0,
  COORDINATOR_SERVICE_STATE,
  RPL_COORDINATOR_LAST_ERROR_NUMBER,
  RPL_COORDINATOR_LAST_ERROR_MESSAGE,
  RPL_COORDINATOR_LAST_ERROR_TIMESTAMP, 
  _RPL_COORDINATOR_LAST_FIELD_= RPL_COORDINATOR_LAST_ERROR_TIMESTAMP
};
...
private:
  ...
  void drop_null(enum enum_rpl_coordinator_field_names f_name);
  void set_null(enum enum_rpl_coordinator_field_names f_name);
  void str_store(enum enum_rpl_coordinator_field_names f_name, const char * val);
  void int_store(enum enum_rpl_coordinator_field_names f_name, longlong val);
  void enum_store(enum enum_rpl_coordinator_field_names f_name, longlong val)
  {
  ...
  ST_STATUS_FIELD_DATA m_fields[_RPL_COORDINATOR_LAST_FIELD_ + 1];
