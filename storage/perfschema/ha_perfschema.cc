  ...
  */
  ...
  for (i = 0; /* empty */; i++)
  {
    ...
    case 4:
      ...
      size = events_waits_history_per_thread *
             global_thread_container.get_row_count() * sizeof(PFS_events_waits);
      total_memory += size;
      break;
    case 5:
...
static int
show_func_mutex_instances_lost(THD *, SHOW_VAR *var, char *buff)
{
  var->type = SHOW_LONG;
  var->value = buff;
...
static struct st_mysql_show_var pfs_status_vars[] = {
  ...
  {"Performance_schema_rwlock_classes_lost",
   (char *)&rwlock_class_lost,
   SHOW_LONG_NOFLUSH,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_cond_classes_lost",
   (char *)&cond_class_lost,
   SHOW_LONG_NOFLUSH,
   SHOW_SCOPE_GLOBAL},
  ...
  {"Performance_schema_file_classes_lost",
   (char *)&file_class_lost,
   SHOW_LONG_NOFLUSH,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_socket_classes_lost",
   (char *)&socket_class_lost,
   SHOW_LONG_NOFLUSH,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_memory_classes_lost",
   (char *)&memory_class_lost,
   SHOW_LONG_NOFLUSH,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_mutex_instances_lost",
   (char *)&show_func_mutex_instances_lost,
   SHOW_FUNC,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_rwlock_instances_lost",
   (char *)&global_rwlock_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_cond_instances_lost",
   (char *)&global_cond_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_thread_instances_lost",
   (char *)&global_thread_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_file_instances_lost",
   (char *)&global_file_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  ...
  {"Performance_schema_table_instances_lost",
   (char *)&global_table_share_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  /* table handles, can be flushed */
  {"Performance_schema_table_handles_lost",
   (char *)&global_table_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  ...
  {"Performance_schema_index_stat_lost",
   (char *)&global_table_share_index_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_hosts_lost",
   (char *)&global_host_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_users_lost",
   (char *)&global_user_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_accounts_lost",
   (char *)&global_account_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_stage_classes_lost",
   (char *)&stage_class_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_statement_classes_lost",
   (char *)&statement_class_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  ...
  {"Performance_schema_session_connect_attrs_lost",
   (char *)&session_connect_attrs_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_session_connect_attrs_longest_seen",
   (char *)&session_connect_attrs_longest_seen,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_program_lost",
   (char *)&global_program_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_nested_statement_lost",
   (char *)&nested_statement_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_prepared_statements_lost",
   (char *)&global_prepared_stmt_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
  {"Performance_schema_metadata_lock_lost",
   (char *)&global_mdl_container.m_lost,
   SHOW_LONG,
   SHOW_SCOPE_GLOBAL},
...
int
ha_perfschema::write_row(uchar *buf)
{
  int result;
...
void
ha_perfschema::use_hidden_primary_key(void)
{
  /*
...
int
ha_perfschema::update_row(const uchar *old_data, uchar *new_data)
{
...
int
ha_perfschema::delete_row(const uchar *buf)
{
...
int
ha_perfschema::rnd_init(bool scan)
{
  int result;
...
int
ha_perfschema::rnd_next(uchar *buf)
{
...
void
ha_perfschema::position(const uchar *)
{
...
int
ha_perfschema::rnd_pos(uchar *buf, uchar *pos)
{
...
int
ha_perfschema::delete_all_rows(void)
{
  int result;
...
void
ha_perfschema::print_error(int error, myf errflag)
{
  switch (error)
  {
  case HA_ERR_TABLE_NEEDS_UPGRADE:
    ...
    */
    my_error(ER_WRONG_NATIVE_TABLE_STRUCTURE,
             MYF(0),
             table_share->db.str,
...
ulong
ha_perfschema::index_flags(uint, uint, bool) const
{
...
*/
int
ha_perfschema::index_init(uint idx, bool sorted)
{
  int result;
...
*/
int
ha_perfschema::index_read(uchar *buf,
                          const uchar *key,
                          uint key_len,
...
*/
int
ha_perfschema::index_next(uchar *buf)
{
...
*/
int
ha_perfschema::index_next_same(uchar *buf, const uchar *key, uint keylen)
{
...
bool
ha_perfschema::is_executed_by_slave() const
{
  DBUG_ASSERT(table != NULL);
