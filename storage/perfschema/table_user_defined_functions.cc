...
ha_rows
table_user_defined_functions::get_row_count(void)
{
  ha_rows count;
  udf_hash_rlock();
  count = udf_hash_size();
...
void
table_user_defined_functions::materialize(THD *thd)
{
  uint size;
...
int
table_user_defined_functions::rnd_next(void)
{
  int result;
...
int
table_user_defined_functions::rnd_pos(const void *pos)
{
  set_position(pos);
...
int
table_user_defined_functions::index_init(uint idx, bool)
{
...
int
table_user_defined_functions::index_next(void)
{
