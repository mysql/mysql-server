...
bool
PFS_index_events_stages::match(PFS_thread *pfs)
{
  if (m_fields >= 1)
  {
...
bool
PFS_index_events_stages::match(PFS_events_stages *pfs)
{
  if (m_fields >= 2)
  {
...
*/
int
table_events_stages_common::make_row(PFS_events_stages *stage)
{
  const char *base;
  ...
  m_normalizer->to_pico(stage->m_timer_start,
                        timer_end,
                        &m_row.m_timer_start,
                        &m_row.m_timer_end,
                        &m_row.m_timer_wait);
...
int
table_events_stages_common::read_row_values(TABLE *table,
                                            unsigned char *buf,
                                            Field **fields,
                                            bool read_all)
{
...
void
table_events_stages_current::reset_position(void)
{
  m_pos.m_index = 0;
...
int
table_events_stages_current::rnd_next(void)
{
...
int
table_events_stages_current::rnd_pos(const void *pos)
{
  PFS_thread *pfs_thread;
  PFS_events_stages *stage;
...
int
table_events_stages_current::index_next(void)
{
  PFS_thread *pfs_thread;
  PFS_events_stages *stage;
...
int
table_events_stages_current::delete_all_rows(void)
{
...
void
table_events_stages_history::reset_position(void)
{
  m_pos.reset();
  m_next_pos.reset();
}
...
int
table_events_stages_history::rnd_next(void)
{
  PFS_thread *pfs_thread;
  PFS_events_stages *stage;
...
int
table_events_stages_history::rnd_pos(const void *pos)
{
  PFS_thread *pfs_thread;
  PFS_events_stages *stage;
...
int
table_events_stages_history::index_next(void)
{
  PFS_thread *pfs_thread;
  PFS_events_stages *stage;
  bool has_more_thread = true;
...
int
table_events_stages_history::delete_all_rows(void)
{
...
void
table_events_stages_history_long::reset_position(void)
{
  m_pos.m_index = 0;
  m_next_pos.m_index = 0;
}
...
int
table_events_stages_history_long::rnd_next(void)
{
  PFS_events_stages *stage;
  uint limit;
...
int
table_events_stages_history_long::rnd_pos(const void *pos)
{
  PFS_events_stages *stage;
  uint limit;
...
int
table_events_stages_history_long::delete_all_rows(void)
{
