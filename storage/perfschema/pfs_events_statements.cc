...
void
cleanup_events_statements_history_long(void)
{
...
*/
void
insert_events_statements_history(PFS_thread *thread,
...
static void
fct_reset_events_statements_current(PFS_thread *pfs_thread)
{
...
void
reset_events_statements_current(void)
{
  global_thread_container.apply_all(fct_reset_events_statements_current);
}

static void
fct_reset_events_statements_history(PFS_thread *pfs_thread)
{
...
void
reset_events_statements_history(void)
{
...
static void
fct_reset_events_statements_by_thread(PFS_thread *thread)
{
...
static void
fct_reset_events_statements_by_account(PFS_account *pfs)
{
...
static void
fct_reset_events_statements_by_user(PFS_user *pfs)
{
...
static void
fct_reset_events_statements_by_host(PFS_host *pfs)
{
  pfs->aggregate_statements();
}
