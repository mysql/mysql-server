...
void
PFS_status_stats::aggregate(const PFS_status_stats *from)
{
  if (from->m_has_stats)
  {
    m_has_stats = true;
...
void
PFS_status_stats::aggregate_from(const System_status_var *from)
{
...
void
PFS_status_stats::aggregate_to(System_status_var *to)
{
  if (m_has_stats)
  {
...
static void
fct_reset_status_by_thread(PFS_thread *thread)
{
  PFS_account *account;
  PFS_user *user;
  PFS_host *host;
...
static void
fct_reset_status_by_account(PFS_account *account)
{
  PFS_user *user;
  PFS_host *host;
