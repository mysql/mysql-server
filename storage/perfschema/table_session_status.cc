...
PFS_engine_table *table_session_status::create(PFS_engine_table_share *) {
...
int table_session_status::make_row(const Status_variable *status_var) {
...
int table_session_status::read_row_values(TABLE *table, unsigned char *buf,
