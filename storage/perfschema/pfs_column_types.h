...
enum enum_operation_type
{
  ...
  OPERATION_TYPE_TL_WRITE_LOW_PRIORITY= 36,
  OPERATION_TYPE_TL_WRITE_NORMAL= 37,
  OPERATION_TYPE_TL_READ_EXTERNAL= 38,
  OPERATION_TYPE_TL_WRITE_EXTERNAL= 39,

  /* Socket operations */
  OPERATION_TYPE_SOCKETCREATE = 40,
  OPERATION_TYPE_SOCKETCONNECT = 41,
  OPERATION_TYPE_SOCKETBIND = 42,
  OPERATION_TYPE_SOCKETCLOSE = 43,
  OPERATION_TYPE_SOCKETSEND = 44,
  OPERATION_TYPE_SOCKETRECV = 45,
  OPERATION_TYPE_SOCKETSENDTO = 46,
  OPERATION_TYPE_SOCKETRECVFROM = 47,
  OPERATION_TYPE_SOCKETSENDMSG = 48,
  OPERATION_TYPE_SOCKETRECVMSG = 49,
  OPERATION_TYPE_SOCKETSEEK = 50,
  OPERATION_TYPE_SOCKETOPT = 51,
  OPERATION_TYPE_SOCKETSTAT = 52,
  OPERATION_TYPE_SOCKETSHUTDOWN = 53,
