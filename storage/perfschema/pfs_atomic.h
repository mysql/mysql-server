...
public:
  ...
  /** Atomic store. */
  static inline void
  store_32(int32 *ptr, int32 value)
  {
  ...
  /** Atomic store. */
  static inline void
  store_64(int64 *ptr, int64 value)
  {
  ...
  /** Atomic store. */
  static inline void
  store_u32(uint32 *ptr, uint32 value)
  {
  ...
  /** Atomic store. */
  static inline void
  store_u64(uint64 *ptr, uint64 value)
  {
  ...
  /** Atomic add. */
  static inline uint32
  add_u32(uint32 *ptr, uint32 value)
  {
  ...
  /** Atomic add. */
  static inline uint64
  add_u64(uint64 *ptr, uint64 value)
  {
  ...
  static inline bool
  cas_32(int32 *ptr, int32 *old_value, int32 new_value)
  {
  ...
  /** Atomic compare and swap. */
  static inline bool
  cas_64(int64 *ptr, int64 *old_value, int64 new_value)
  {
  ...
  /** Atomic compare and swap. */
  static inline bool
  cas_u32(uint32 *ptr, uint32 *old_value, uint32 new_value)
  {
    return my_atomic_cas32((int32 *)ptr, (int32 *)old_value, (uint32)new_value);
  }

  /** Atomic compare and swap. */
  static inline bool
  cas_u64(uint64 *ptr, uint64 *old_value, uint64 new_value)
  {
