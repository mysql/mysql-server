...
enum monitor_id_t {
  ...
  MONITOR_VECTOR_INDEXES_NUM_QUERIES,
  MONITOR_VECTOR_INDEXES_NUM_MUTATIONS,
  MONITOR_VECTOR_INDEXES_NUM_QUERIES_FAILED,
  MONITOR_VECTOR_INDEXES_NUM_MUTATIONS_FAILED,
  MONITOR_VECTOR_INDEXES_NUM_TREE_LOAD,
  MONITOR_VECTOR_INDEXES_NUM_TREE_LOAD_FAILED,
  MONITOR_VECTOR_INDEXES_NUM_TREE_UNLOAD,
  MONITOR_VECTOR_INDEX_SINGLE_THREAD_QUERIES,
