...
struct alignas(ut::INNODB_CACHE_LINE_SIZE) log_t {
   ...
   *
   * Generated by CLion and GPT automatically.
   *
   * TODO: 但是 log_t 是用来管理 Redo Log Buffer 的结构体，而不是 log 本身！
   */
  /*
 log_t(const log_t &other)
     : sn_lock_event(other.sn_lock_event),
       sn_lock_inst(other.sn_lock_inst),
       //        sn(other.sn),
       ...
       //        recent_written(other.recent_written),
       //        writer_threads_paused(other.writer_threads_paused),
       current_ready_waiting_lsn(other.current_ready_waiting_lsn),
       current_ready_waiting_sig_count(other.current_ready_waiting_sig_count),
       //        recent_closed(other.recent_closed),
       //        buf_limit_sn(other.buf_limit_sn),
       //        write_lsn(other.write_lsn),
       write_events(other.write_events),
       write_events_size(other.write_events_size),
       // write_to_file_requests_total(other.write_to_file_requests_total),
       //
write_to_file_requests_interval(other.write_to_file_requests_interval),
       flush_events(other.flush_events),
       flush_events_size(other.flush_events_size),
       old_flush_event(other.old_flush_event),
       //        flushed_to_disk_lsn(other.flushed_to_disk_lsn),
       last_flush_start_time(other.last_flush_start_time),
       last_flush_end_time(other.last_flush_end_time),
       flush_avg_time(other.flush_avg_time),
       //        flusher_mutex(other.flusher_mutex),
       flusher_event(other.flusher_event),
       write_ahead_buf_size(other.write_ahead_buf_size),
       write_ahead_buf(other.write_ahead_buf),
       write_ahead_end_offset(other.write_ahead_end_offset),
       m_current_file(other.m_current_file),
       //        m_current_file_handle(other.m_current_file_handle),
       m_writer_inside_extra_margin(other.m_writer_inside_extra_margin),
       n_log_ios(other.n_log_ios),
       //        writer_mutex(other.writer_mutex),
       m_writer_thd(other.m_writer_thd),
       m_remote_buf_thd(other.m_remote_buf_thd),
       writer_event(other.writer_event),
       m_oldest_need_lsn_lowerbound(other.m_oldest_need_lsn_lowerbound),
       closer_event(other.closer_event),
       //        closer_mutex(other.closer_mutex),
       flush_notifier_event(other.flush_notifier_event),
       current_flush_sig_count(other.current_flush_sig_count),
       //        flush_notifier_mutex(other.flush_notifier_mutex),
       //        write_notifier_mutex(other.write_notifier_mutex),
       write_notifier_event(other.write_notifier_event),
       //        m_files_mutex(other.m_files_mutex),
       m_files_ctx(other.m_files_ctx),
       //        m_files(other.m_files),
       m_unused_files_count(other.m_unused_files_count),
       m_unused_file_size(other.m_unused_file_size),
       //        m_capacity(other.m_capacity),
       m_requested_files_consumption(other.m_requested_files_consumption),
       m_files_stats(other.m_files_stats),
       m_files_governor_event(other.m_files_governor_event),
       m_files_governor_iteration_event(
           other.m_files_governor_iteration_event),
       //        m_no_more_dummy_records_requested(
       //            other.m_no_more_dummy_records_requested),
       //        m_no_more_dummy_records_promised(
       //            other.m_no_more_dummy_records_promised),
       m_files_governor_thd(other.m_files_governor_thd),
       m_file_removed_event(other.m_file_removed_event),
       //        m_encryption_buf(other.m_encryption_buf),
       m_encryption_metadata(other.m_encryption_metadata),
       m_consumers(other.m_consumers),
       //        should_stop_threads(other.should_stop_threads),
       writer_threads_resume_event(other.writer_threads_resume_event),
       //        write_notifier_resume_lsn(other.write_notifier_resume_lsn),
       //        flush_notifier_resume_lsn(other.flush_notifier_resume_lsn),
       n_log_ios_old(other.n_log_ios_old),
       last_printout_time(other.last_printout_time),
       recovered_lsn(other.recovered_lsn),
       m_format(other.m_format),
       m_creator_name(other.m_creator_name),
       m_log_flags(other.m_log_flags),
       m_log_uuid(other.m_log_uuid),
       m_scanned_lsn(other.m_scanned_lsn),
       disable_redo_writes(other.disable_redo_writes),
       //        limits_mutex(other.limits_mutex),
       available_for_checkpoint_lsn(other.available_for_checkpoint_lsn),
       requested_checkpoint_lsn(other.requested_checkpoint_lsn),
       dict_max_allowed_checkpoint_lsn(other.dict_max_allowed_checkpoint_lsn),
       periodical_checkpoints_enabled(other.periodical_checkpoints_enabled),
       //        m_allow_checkpoints(other.m_allow_checkpoints),
       //        free_check_limit_lsn(other.free_check_limit_lsn),
       //        concurrency_margin(other.concurrency_margin),
       //        concurrency_margin_is_safe(other.concurrency_margin_is_safe),
       //        dict_persist_margin(other.dict_persist_margin),
       checkpointer_event(other.checkpointer_event),
       //        checkpointer_mutex(other.checkpointer_mutex),
       //        last_checkpoint_lsn(other.last_checkpoint_lsn),
       next_checkpoint_header_no(other.next_checkpoint_header_no),
       next_checkpoint_event(other.next_checkpoint_event),
       last_checkpoint_time(other.last_checkpoint_time),
       m_checkpoint_consumer(other.m_checkpoint_consumer),
       m_checkpointer_thd(other.m_checkpointer_thd) {}
};
*/
