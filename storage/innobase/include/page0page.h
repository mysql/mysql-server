...
Differs from the function cmp_dtuple_rec_with_match
in the way that the record must reside on an
index page, and also page infimum and supremum records can be given in
the parameter rec. These are considered as the negative infinity and
the positive infinity in the alphabetical order.
@param[in]	dtuple		data tuple
@param[in]	rec		record in a B-tree page
(may also be page infimum or supremum)
@param[in]	offsets		rec_get_offsets(rec, index),
can be NULL if the index page is in ROW_FORMAT=REDUNDANT
