...
UNIV_INLINE
dtuple_t *dtuple_create_from_mem(
    /*===================*/
    void *buf, ulint buf_size, ulint n_fields, ulint n_v_fields)
    MY_ATTRIBUTE((warn_unused_result));
/**********************************************************/ /**
