...
@return checksum */
UNIV_INLINE
ulint log_block_calc_checksum_crc32(const byte *block);
...
void log_get_last_block(lsn_t &last_lsn, byte *last_block, uint32_t &block_len);
