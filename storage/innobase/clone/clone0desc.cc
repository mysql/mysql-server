...
void Clone_Desc_Header::deserialize(byte *desc_hdr) {
...
void Clone_Desc_Locator::init(ib_uint64_t id, ib_uint64_t snap_id, uint version,
                              uint index) {
...
void Clone_Desc_Locator::deserialize(byte *desc_loc) {
...
void Clone_Desc_Task_Meta::deserialize(byte *desc_task) {
...
void Clone_Desc_File_MetaData::deserialize(byte *desc_file) {
...
void Clone_Desc_State::deserialize(byte *desc_state) {
...
void Clone_Desc_Data::deserialize(byte *desc_data) {
