...
*/
static void trx_undo_get_mbr_from_ext(
    /*======================*/
    trx_t *trx, dict_index_t *index, double *mbr, const page_size_t &page_size,
    const byte *field, ulint *len, const dd::Spatial_reference_system *srs) {
  uchar *dptr = NULL;
  ulint dlen;
  mem_heap_t *heap = mem_heap_create(100);

  dptr = lob::btr_copy_externally_stored_field(index, &dlen, field, page_size,
                                               *len, false, heap);
