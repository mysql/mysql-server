...
LatchDebug::LatchDebug()
{
	...
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_1);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_2);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_3);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_4);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_5);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_6);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_7);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_8);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_9);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_10);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_11);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_12);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_13);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_14);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_15);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_16);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_17);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_18);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_19);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_20);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_21);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_22);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_23);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_24);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_25);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_26);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_27);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_28);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_29);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_30);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_UNDO);
	LEVEL_MAP_INSERT(SYNC_FIL_SHARD_REDO);
	...
	UNIV_NOTHROW
{
	...
	case SYNC_FIL_SHARD_UNDO:
	case SYNC_FIL_SHARD_REDO:
	...
	UNIV_NOTHROW
{
	...
	LATCH_ADD_MUTEX(
		FIL_SHARD_UNDO, SYNC_FIL_SHARD_UNDO, fil_system_mutex_key);

	LATCH_ADD_MUTEX(
		FIL_SHARD_REDO, SYNC_FIL_SHARD_REDO, fil_system_mutex_key);
	...
	LATCH_ADD_MUTEX(CLONE_TASK, SYNC_NO_ORDER_CHECK,
