...
#ifndef MYSQL_SETS_BOUNDARY_SET_SUBTRACTION_VIEW_H
#define MYSQL_SETS_BOUNDARY_SET_SUBTRACTION_VIEW_H
...
class Subtraction_view<Source1_tp, Source2_tp>
    : public detail::Boundary_set_binary_operation_view_base<
          Source1_tp, Source2_tp, Binary_operation::op_subtraction> {
  using Base_t = detail::Boundary_set_binary_operation_view_base<
      Source1_tp, Source2_tp, Binary_operation::op_subtraction>;

 public:
  /// Construct a new, empty Subtraction_view.
  ...
  Subtraction_view(const Source1_tp &source1,
...
#endif  // ifndef MYSQL_SETS_BOUNDARY_SET_SUBTRACTION_VIEW_H
