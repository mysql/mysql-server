...
#ifndef MYSQL_CONCURRENCY_CONDITION_VARIABLE_STL_H
#define MYSQL_CONCURRENCY_CONDITION_VARIABLE_STL_H

#ifdef MYSQL_CONCURRENCY_CONDITION_VARIABLE_SRV_H
...
using Cv_key = Key_stub;

}  // namespace mysql::concurrency

/// @}

#endif  // MYSQL_CONCURRENCY_CONDITION_VARIABLE_STL_H
