...
class Krb5_interface {
  ...
  */
  ...
  /**
   ...
   @{
  */
  krb5_build_principal_type krb5_build_principal_ptr;
  krb5_cc_close_type krb5_cc_close_ptr;
  krb5_cc_default_type krb5_cc_default_ptr;
  krb5_cc_get_principal_type krb5_cc_get_principal_ptr;
  krb5_cc_initialize_type krb5_cc_initialize_ptr;
  krb5_cc_remove_cred_type krb5_cc_remove_cred_ptr;
  krb5_cc_retrieve_cred_type krb5_cc_retrieve_cred_ptr;
  krb5_cc_store_cred_type krb5_cc_store_cred_ptr;
  krb5_free_context_type krb5_free_context_ptr;
  krb5_free_cred_contents_type krb5_free_cred_contents_ptr;
  krb5_free_default_realm_type krb5_free_default_realm_ptr;
  krb5_free_error_message_type krb5_free_error_message_ptr;
  krb5_free_principal_type krb5_free_principal_ptr;
  krb5_free_unparsed_name_type krb5_free_unparsed_name_ptr;
  krb5_get_default_realm_type krb5_get_default_realm_ptr;
  krb5_get_error_message_type krb5_get_error_message_ptr;
  krb5_get_init_creds_opt_alloc_type krb5_get_init_creds_opt_alloc_ptr;
  krb5_get_init_creds_opt_free_type krb5_get_init_creds_opt_free_ptr;
  krb5_get_init_creds_password_type krb5_get_init_creds_password_ptr;
  krb5_get_profile_type krb5_get_profile_ptr;
  krb5_init_context_type krb5_init_context_ptr;
  krb5_parse_name_type krb5_parse_name_ptr;
  krb5_timeofday_type krb5_timeofday_ptr;
  krb5_unparse_name_type krb5_unparse_name_ptr;
  krb5_verify_init_creds_type krb5_verify_init_creds_ptr;
  profile_get_boolean_type profile_get_boolean_ptr;
  profile_get_string_type profile_get_string_ptr;
  profile_release_type profile_release_ptr;
  profile_release_string_type profile_release_string_ptr;
  /**@}*/
