...
static bool flashback_multi_tables=0;
...
static char *flashback_tables=0;
static std::set<std::string> flashback_filter_tables;
          ...
          if (skip_event) {
            if (!opt_flashback){
              ...
              if (copy_event_cache_to_string_and_reinit(
                ...
                goto err;
              ev->output_buf.append((const char *)tmp_str.str,
                                    tmp_str.length);  // Not \0 terminated);
...
static struct my_option my_long_options[] = {
    ...
    */
    ...
    {"flashback", 'B', 
      ...
      &opt_flashback, &opt_flashback, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, nullptr, 0, nullptr},
    {"flashback-tables", OPT_FLASHBACK_TABLES, 
     ...
     &flashback_tables, &flashback_tables, nullptr, GET_STR_ALLOC, REQUIRED_ARG, 0, 0, 0, nullptr, 0, nullptr},
