...
--echo # WL15875 remove deprecated privilege
...
--echo
--echo # Should not return any rows.
--echo
...
--echo
--echo # Should show the routine_definition of all 4 routines.
--echo
SELECT ROUTINE_DEFINITION FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA="testdb" ORDER BY ROUTINE_DEFINITION;

--echo
--echo # Should show the Create Procedure string.
--echo
SHOW CREATE PROCEDURE testdb.proc_root;
SHOW CREATE PROCEDURE testdb.proc_definer;

--echo
--echo # Should show the Create Function string.
--echo
SHOW CREATE FUNCTION testdb.func_root;
SHOW CREATE FUNCTION testdb.func_definer;

--echo
--echo # Should show properties of proc_root and proc_definer.
--echo
--replace_column 6 '0000-00-00 00:00:00' 7 '0000-00-00 00:00:00'
SHOW PROCEDURE STATUS WHERE db="testdb";
--echo
--echo # Should show properties of func_root and func_definer.
--echo
--replace_column 6 '0000-00-00 00:00:00' 7 '0000-00-00 00:00:00'
SHOW FUNCTION STATUS WHERE db="testdb";
...
--echo
--echo # Should show the routine_definition of only proc_definer and func_definer.
--echo
SELECT ROUTINE_DEFINITION FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA="testdb" ORDER BY ROUTINE_DEFINITION;
...
--echo # Should show properties of proc_definer.
--echo
--replace_column 6 '0000-00-00 00:00:00' 7 '0000-00-00 00:00:00'
SHOW PROCEDURE STATUS WHERE db="testdb";
--echo
--echo # Should show properties of func_definer.
--echo
--replace_column 6 '0000-00-00 00:00:00' 7 '0000-00-00 00:00:00'
SHOW FUNCTION STATUS WHERE db="testdb";
...
--echo
--echo # Should show NULL routine_definition for all 4 routines.
--echo
SELECT ROUTINE_DEFINITION FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA="testdb" ORDER BY ROUTINE_DEFINITION;

--echo
--echo # Should show NULL Create Procedure string.
--echo
SHOW CREATE PROCEDURE testdb.proc_root;
SHOW CREATE PROCEDURE testdb.proc_definer;

--echo
--echo # Should show NULL Create Function string.
--echo
SHOW CREATE FUNCTION testdb.func_root;
SHOW CREATE FUNCTION testdb.func_definer;
...
--echo
--echo # Test showing properties after partial revoke of SELECT privilege.
--echo
--connection default
