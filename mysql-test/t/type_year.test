...
--echo #
--echo # Bug#29616536: Cast of YEAR column returns wrong result
--echo #

CREATE TABLE t1 (a YEAR);
INSERT INTO t1 VALUES (98);
INSERT INTO t1 VALUES (2010);
SELECT CAST(a AS DATE) AS d, CAST(a AS DATETIME) AS dt FROM t1;
SELECT LEAST(a, DATE'2000-01-01') AS l, GREATEST(a, DATE'2000-01-01') AS g
FROM t1;
DROP TABLE t1;
