...
CREATE TABLE t2(f1 JSON, INDEX idx1 ((CAST(f1->>"$.name" AS CHAR(30) CHARSET utf8mb3)  COLLATE utf8mb3_bin)));
EXPLAIN SELECT * FROM t2 WHERE CAST(f1->>"$.name" AS CHAR(30) CHARSET utf8mb3) COLLATE utf8mb3_bin = "james";
DROP TABLE t1, t2;
