...
SELECT GREATEST(5, -5) AS c1,
       ...
       GREATEST(010101.0, timestamp '2005-05-05 05:05:05.555555') AS c16,
...
--echo #
--echo # Bug#38482019: Assertion 'false' failed sql/item_func.cc
--echo #
CREATE TABLE t1(t TIME, d DATE, y YEAR);

INSERT INTO t1 VALUES(TIME'12:02:12', DATE'2024-09-03', 2025);

SET TIMESTAMP = UNIX_TIMESTAMP('2025-01-01 00:00:00');

SELECT FROM_UNIXTIME(GREATEST(d, t, y)) FROM t1;
