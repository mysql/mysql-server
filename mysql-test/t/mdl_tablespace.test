...
--reap
--connection con2
# InnoDB does not support ALTER TABLESPACE  ADD DATAFILE
...
--echo #
--echo # Set utf8mb3 character set to allow multi byte characters.
...
SET DEBUG_SYNC= 'after_wait_locked_tablespace_name_for_table
  SIGNAL got_lock
  WAIT_FOR cont';
--send CREATE TABLE t3 ( a INT NOT NULL, PRIMARY KEY (a)) ENGINE=InnoDB TABLESPACE ts1;
