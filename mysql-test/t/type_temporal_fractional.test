...
--echo #
--echo # Testing Item_typecast_time::val_time()
--echo #
...
--echo # This tests Field::val_time().
CREATE TABLE t1 (a VARCHAR(32));
INSERT INTO t1 VALUES
...
--echo #
--echo # Testing that Item::val_time() rounds
--echo #
...
--echo #
--echo # Testing Item_typecast_datetime::val_datetime()
--echo #
