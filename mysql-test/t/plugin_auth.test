...
GRANT SYSTEM_USER ON *.* TO grant_plug;
...
# 32 characters user name
CREATE USER очень_очень_очень_длинный_юзер__@localhost IDENTIFIED WITH 'caching_sha2_password' BY 'auth_string';
...
# 32 characters user name
CREATE USER очень_очень_очень_длинный_юзер__@localhost IDENTIFIED WITH 'caching_sha2_password' BY 'auth_string' REQUIRE SSL;
