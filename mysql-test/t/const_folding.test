...
--echo #
--echo # Bug#36361165 Incorrect query result caused by comparing decimal and float type value
--echo #
...
let $query=
SELECT (t0.c0 <= -0.8) AS flag FROM t0;
...
--echo # This patch also closes Bug#36492878. Its repro:
CREATE TABLE decimal_test (id BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY,
                           decval DECIMAL (12, 2) NOT NULL);
