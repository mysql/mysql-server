...
--echo #
--echo # Bug#58005 utf8mb3 + get_format causes failed assertion: !str || str != Ptr'
--echo #
SET NAMES utf8mb3;
...
--echo # Bug#35591118: Assertion 'data_type() != MYSQL_TYPE_INVALID' failed
...
EXECUTE ps USING @iso;

DEALLOCATE PREPARE ps;

--error ER_PARSE_ERROR
PREPARE ps FROM "SELECT GET_FORMAT(?, 'ISO')";

--echo #
--echo # Bug#34704094: Mysql str_to_date can correct convert for '2022-11-30'
--echo #
