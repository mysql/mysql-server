...
let $test_query = SELECT * FROM t1 IGNORE INDEX (f1) ORDER BY f1;
--source include/mem_cnt_check_err.inc
...
--echo # Testing memory/sql/hashed_operation.
CREATE TABLE t0(c0 INT);
CREATE TABLE t3(c0 DOUBLE);
# Make the tables big enough to ensure that a hash join is chosen.
INSERT INTO t0 VALUES (0), (1), (2), (3), (4), (5), (6);
INSERT INTO t3 SELECT c0 + 1 FROM t0;
