...
--echo #
--echo # Bug#35135132 bool String::copy -
--echo #              Assertion `!str || str != m_ptr' failed.
--echo #
...
--echo #
--echo # Bug#38883917: WL#16895: Assertion 'm_eval_type == MYSQL_TYPE_DATETIME'
--echo #
...
INSERT INTO t1 VALUES
 (TIMESTAMP'1996-04-20 20:22:36', TIMESTAMP'2000-12-31 22:01:01'),
 (TIMESTAMP'2024-04-01 13:18:49', TIMESTAMP'1980-01-12 23:38:06');

SELECT ts1, ts2, GREATEST(ts1, ts2) AS f FROM t1;
