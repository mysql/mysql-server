...
--echo #
--echo # BUG#12837084 - SEGFAULT IN ADD_FOUND_MATCH_TRIG_COND
--echo #
...
# The bug depended on the optimizer enumerating query plans in a certain order, so
# optimizing index stats is needed to trigger the bug.
OPTIMIZE TABLE t1;
...
# Again for statistics reasons, long records are needed for t3:
