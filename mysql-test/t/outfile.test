...
# Server is started in "var/master-data", so "../../tmp" will be "var/tmp"
--eval set @tmpdir="../../tmp"
--enable_query_log
...
# The hypergraph optimizer does not support the traditional explain
# format yet. Automatic filtering of hypergraph errors is broken for
# this test on some platforms due to older versions of diff getting
# confused by binary characters in the result file. Force the use of
# the old optimizer with a hint for now.
EXPLAIN
