...
--connection con1
--remove_file $MYSQLD_DATADIR/test/t1.CSV
# Error returned depends on platform
--replace_result $MYSQLD_DATADIR MYSQLD_DATADIR/ ./ MYSQLD_DATADIR/ "13 - Permission denied" "2 - No such file or directory"
# EE_FILENOTFOUND 29
--error 29
select * from t1;
--disconnect con1
...
--echo #
--echo # Bug#32597017: CSV ENGINE (TINA) DOES NOT HANDLE JSON TYPE
--echo #
