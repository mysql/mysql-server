...
--connection default
--echo # con default
--skip_if_hypergraph  # Doesn't use the index, so the plan is still valid.
...
insert into test12 values('Tom1',20,1,'2017-08-25 12:12:12',1),
('Tom2',21,1,'2017-08-25 12:12:12',1),
('Tom3',23,1,'2017-08-25 12:12:12',1),
('Tom4',24,1,'2017-08-25 12:11:12',1),
('Tom5',25,1,'2017-08-25 11:12:12',1),
('Tom6',26,1,'2017-08-25 12:12:11',1),
('Tom7',27,1,'2017-08-25 12:13:11',1);
ANALYZE TABLE test12;

begin;update test12 set grade=3,date=now()  where age>22 and age<24 and
partition_id=1;
...
INSERT INTO t1 VALUES (4, '2018-04-25 10:18:03', '1');
INSERT INTO t1 VALUES (5, '2018-04-25 10:18:04', '1');
INSERT INTO t1 VALUES (6, '2018-04-25 10:18:05', '1');
ANALYZE TABLE t1;
...
--skip_if_hypergraph  # Index not supported, so different query plan.
