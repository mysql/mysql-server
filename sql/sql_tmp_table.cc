...
update_hidden:
  ...
  */
  ...
  table->file= get_new_handler(share, &share->mem_root, share->db_type());
                           ...
                           ulonglong options, my_bool big_tables)
{
  ...
  if (open_tmp_table(table))
  {
    ...
    */
    table->file->ha_delete_table(share->table_name.str); /* purecov: inspected */
    return TRUE;
  }
                             ...
                             bool *is_duplicate)
{
  ...
  while (true)
  {
    ...
    */
    ...
    if (!(new_table.file= get_new_handler(&share, &new_table.s->mem_root,
                                          new_table.s->db_type())))
