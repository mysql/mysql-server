...
TABLE *create_tmp_table(THD *thd, Temp_table_param *param,
  ...
  */
  bool unique_constraint_via_hash_field =
      param->m_operation != Temp_table_param::TTP_UNION;
  ...
  *blob_field = 0;  // End marker
  ...
  } else if ((distinct || param->m_operation != Temp_table_param::TTP_UNION) &&
  ...
  */
  ...
  if (unique_constraint_via_hash_field) {
    if (param->needs_set_counter()) {
      ...
      share->field--;
      table->m_set_counter = set_counter;
      table->m_last_operation_is_distinct = param->m_last_operation_is_distinct;
      table->m_except = param->m_operation == Temp_table_param::TTP_EXCEPT;
    }
