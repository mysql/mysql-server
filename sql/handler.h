...
public:
  ...
  */
  ...
  static const HA_ALTER_FLAGS ADD_INDEX                  = 1LL << 0;

  // Drop non-unique, non-primary index
  static const HA_ALTER_FLAGS DROP_INDEX                 = 1LL << 1;

  // Add unique, non-primary index
  static const HA_ALTER_FLAGS ADD_UNIQUE_INDEX           = 1LL << 2;

  // Drop unique, non-primary index
  static const HA_ALTER_FLAGS DROP_UNIQUE_INDEX          = 1LL << 3;

  // Add primary index
  static const HA_ALTER_FLAGS ADD_PK_INDEX               = 1LL << 4;

  // Drop primary index
  static const HA_ALTER_FLAGS DROP_PK_INDEX              = 1LL << 5;

  // Add column
  static const HA_ALTER_FLAGS ADD_COLUMN                 = 1LL << 6;

  // Drop column
  static const HA_ALTER_FLAGS DROP_COLUMN                = 1LL << 7;

  // Rename column
  static const HA_ALTER_FLAGS ALTER_COLUMN_NAME          = 1LL << 8;

  // Change column datatype
  static const HA_ALTER_FLAGS ALTER_COLUMN_TYPE          = 1LL << 9;
  ...
  */
  static const HA_ALTER_FLAGS ALTER_COLUMN_EQUAL_PACK_LENGTH = 1LL << 10;

  // Reorder column
  static const HA_ALTER_FLAGS ALTER_COLUMN_ORDER         = 1LL << 11;

  // Change column from NOT NULL to NULL
  static const HA_ALTER_FLAGS ALTER_COLUMN_NULLABLE      = 1LL << 12;

  // Change column from NULL to NOT NULL
  static const HA_ALTER_FLAGS ALTER_COLUMN_NOT_NULLABLE  = 1LL << 13;

  // Set or remove default column value
  static const HA_ALTER_FLAGS ALTER_COLUMN_DEFAULT       = 1LL << 14;

  // Add foreign key
  static const HA_ALTER_FLAGS ADD_FOREIGN_KEY            = 1LL << 15;

  // Drop foreign key
  static const HA_ALTER_FLAGS DROP_FOREIGN_KEY           = 1LL << 16;

  // table_options changed, see HA_CREATE_INFO::used_fields for details.
  static const HA_ALTER_FLAGS CHANGE_CREATE_OPTION       = 1LL << 17;

  // Table is renamed
  static const HA_ALTER_FLAGS ALTER_RENAME               = 1LL << 18;

  // Change the storage type of column 
  static const HA_ALTER_FLAGS ALTER_COLUMN_STORAGE_TYPE = 1LL << 19;

  // Change the column format of column
  static const HA_ALTER_FLAGS ALTER_COLUMN_COLUMN_FORMAT = 1LL << 20;

  // Add partition
  static const HA_ALTER_FLAGS ADD_PARTITION              = 1LL << 21;

  // Drop partition
  static const HA_ALTER_FLAGS DROP_PARTITION             = 1LL << 22;

  // Changing partition options
  static const HA_ALTER_FLAGS ALTER_PARTITION            = 1LL << 23;

  // Coalesce partition
  static const HA_ALTER_FLAGS COALESCE_PARTITION         = 1LL << 24;

  // Reorganize partition ... into
  static const HA_ALTER_FLAGS REORGANIZE_PARTITION       = 1LL << 25;

  // Reorganize partition
  static const HA_ALTER_FLAGS ALTER_TABLE_REORG          = 1LL << 26;

  // Remove partitioning
  static const HA_ALTER_FLAGS ALTER_REMOVE_PARTITIONING  = 1LL << 27;

  // Partition operation with ALL keyword
  static const HA_ALTER_FLAGS ALTER_ALL_PARTITION        = 1LL << 28;
  ...
  */
  static const HA_ALTER_FLAGS RENAME_INDEX               = 1LL << 29;

  /**
    Recreate the table for ALTER TABLE FORCE, ALTER TABLE ENGINE
    and OPTIMIZE TABLE operations.
  */
  static const HA_ALTER_FLAGS RECREATE_TABLE             = 1LL << 30;
