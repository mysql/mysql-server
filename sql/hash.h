...
#ifndef SQL_HASH_INCLUDED
#define SQL_HASH_INCLUDED

#include <cstdint>
#include <string>

inline constexpr uint64_t kNullStrHash =
    3424785146145211351ULL;  // value of HashCString("X");
