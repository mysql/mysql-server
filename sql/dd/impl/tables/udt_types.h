...
#ifndef DD_TABLES__TYPES_INCLUDED
#define DD_TABLES__TYPES_INCLUDED
...
class UDT_Types : public Entity_object_table_impl {
 public:
  ...
  UDT_Type *create_entity_object(const Raw_record &) const override;
...
#endif  // DD_TABLES__TYPES_INCLUDED
