...
#include "dd/impl/system_views/files.h"
...
Files::Files()
{
  ...
  m_target_def.add_field(FIELD_FILE_ID, "FILE_ID",
                         "INTERNAL_TABLESPACE_ID(ts.name, ts.engine, "
                         "ts.se_private_data)");
  ...
  m_target_def.add_field(FIELD_FILE_TYPE, "FILE_TYPE",
                         "INTERNAL_TABLESPACE_TYPE(ts.name, ts.engine, "
                         "ts.se_private_data)");
  ...
  m_target_def.add_field(FIELD_DATA_FREE, "DATA_FREE",
                         "INTERNAL_TABLESPACE_DATA_FREE(ts.name, "
                         "ts.engine, ts.se_private_data)");
  ...
  m_target_def.add_field(FIELD_STATUS, "STATUS",
                         "INTERNAL_TABLESPACE_STATUS(ts.name, "
                         "ts.engine, ts.se_private_data)");
