...
/*
  The class representing INFORMATION_SCHEMA.INNODB_DATAFILES system view definition

*/
class Innodb_datafiles : public System_view_impl<System_view_select_definition_impl>
{
public:
  enum enum_fields
  {
