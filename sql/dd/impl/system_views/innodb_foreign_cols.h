...
/*
  The class representing INFORMATION_SCHEMA.INNODB_FOREIGN_COLS system view definition

*/
class Innodb_foreign_cols : public System_view_impl<System_view_select_definition_impl>
{
public:
  enum enum_fields
  {
