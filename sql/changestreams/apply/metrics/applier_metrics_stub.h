...
#ifndef CHANGESTREAMS_APPLY_METRICS_APPLIER_METRICS_STUB_H
#define CHANGESTREAMS_APPLY_METRICS_APPLIER_METRICS_STUB_H
...
#endif /* CHANGESTREAMS_APPLY_METRICS_APPLIER_METRICS_STUB_H */
