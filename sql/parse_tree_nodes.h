...
class PT_grant_user_attribute final : public Parse_tree_root {
  Sql_cmd_grant_user_attribute sql_cmd;
  public:
    PT_grant_user_attribute(LEX_STRING attrib_arg, LEX_STRING value_arg, List<LEX_USER> *user_list_arg) : 
              sql_cmd(attrib_arg, value_arg, user_list_arg) {}
    Sql_cmd *make_cmd(THD *thd) override;
};

class PT_grant_object_attribute final : public Parse_tree_root {
  Sql_cmd_grant_object_attribute sql_cmd;
  public:
    PT_grant_object_attribute(LEX_STRING attrib_arg, 
