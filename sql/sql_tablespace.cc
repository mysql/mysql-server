...
bool validate_tspnamelen(const LEXSTR &name)
{
  ...
  if (name.length > NAME_LEN ||
      my_numchars_mb(system_charset_info, name.str,
...
public:
  ...
  ~Rollback_guard()
  {
     ...
     if (m_hton != nullptr && ddl_is_atomic(m_hton) && m_hton->post_ddl != nullptr)
     {
...
bool lock_rec(THD *thd, MDL_request_list *rlst, const LEX_STRING &tsp)
{
  ...
  MDL_REQUEST_INIT(&tail_request,
                   MDL_key::TABLESPACE, "", tsp.str,
...
bool get_stmt_hton(THD *thd, const LEX_STRING &engine,
                   const char *object_name,
                   const char *statement,
                   handlerton **htonp)
{
  handlerton *hton= nullptr;
  if (engine.str != nullptr && resolve_engine(thd, engine, false, false, &hton))
  {
    return true;
  }
...
bool Sql_cmd_create_tablespace::execute(THD *thd)
{
  ...
  if (validate_comment_length(thd, m_options->ts_comment.str, &cl,
  ...
  */
  ...
  st_alter_tablespace ts_info{m_tablespace_name.str,
      m_logfile_group_name.str, CREATE_TABLESPACE,
      TS_ALTER_TABLESPACE_TYPE_NOT_DEFINED, m_datafile_name.str, nullptr,
      *m_options};

  if (map_errors(hton->alter_tablespace(hton, thd, &ts_info, tsmp.first,
                                        tsmp.second),
...
Sql_cmd_drop_tablespace::Sql_cmd_drop_tablespace(const LEX_STRING &tsname,
                                                 const Tablespace_options
                                                 *options)
  : Sql_cmd_tablespace{tsname, options}
  {}
...
bool Sql_cmd_drop_tablespace::execute(THD *thd)
{
  ...
  */
  ...
  st_alter_tablespace ts_info{m_tablespace_name.str,
      nullptr, DROP_TABLESPACE,
      TS_ALTER_TABLESPACE_TYPE_NOT_DEFINED, nullptr, nullptr, *m_options};

  int ha_error= hton->alter_tablespace(hton, thd, &ts_info, old_ts_def,
                                    nullptr);
...
bool Sql_cmd_alter_tablespace_add_datafile::execute(THD *thd)
{
  ...
  tsf_obj->set_filename(dd::String_type{m_datafile_name.str,
        m_datafile_name.length});

  handlerton *hton= nullptr;
  if (get_dd_hton(thd, tsmp.first->engine(), m_options->engine_name,
                  m_tablespace_name.str, "ALTER TABLESPACE ... ADD DATAFILE", &hton))
  {
    return true;
  }
  rollback_on_return.m_hton= hton;
  ...
  */
  ...
  st_alter_tablespace ts_info{m_tablespace_name.str,
      nullptr, ALTER_TABLESPACE,
      ALTER_TABLESPACE_ADD_FILE, m_datafile_name.str,
      nullptr, *m_options};
...
bool Sql_cmd_alter_tablespace_drop_datafile::execute(THD *thd)
{
  ...
  if (tsmp.second->remove_file(dd::String_type{m_datafile_name.str,
          m_datafile_name.length}))
  {
  ...
  handlerton *hton= nullptr;
  if (get_dd_hton(thd, tsmp.first->engine(), m_options->engine_name,
                  m_tablespace_name.str, "ALTER TABLESPACE ... DROP DATAFILE",  &hton))
  {
    return true;
  }
  rollback_on_return.m_hton= hton;
  ...
  */
  ...
  st_alter_tablespace ts_info{m_tablespace_name.str,
      nullptr, ALTER_TABLESPACE,
      ALTER_TABLESPACE_DROP_FILE, m_datafile_name.str,
      nullptr, *m_options};
  if (map_errors(hton->alter_tablespace(hton, thd, &ts_info, tsmp.first,
                                        tsmp.second),
...
Sql_cmd_alter_tablespace_rename(const LEX_STRING &old_name,
  ...
  : Sql_cmd_tablespace{old_name, nullptr},
    m_new_name(new_name)
{}
...
bool Sql_cmd_alter_tablespace_rename::execute(THD *thd)
{
  ...
  if (get_dd_hton(thd, tsmp.first->engine(), {nullptr, 0},
                  m_tablespace_name.str, "ALTER TABLESPACE ... RENAME TO", &hton))
  {
    return true;
  }
  if (ha_is_storage_engine_disabled(hton))
  ...
  */
  ...
  st_alter_tablespace ts_info{m_tablespace_name.str,
      nullptr, ALTER_TABLESPACE,
      ALTER_TABLESPACE_RENAME, nullptr,
      nullptr, Tablespace_options{}};
  if (map_errors(hton->alter_tablespace(hton, thd, &ts_info, tsmp.first, tsmp.second),
  ...
  auto compensate_grd= dd::sdi_utils::make_guard
    (hton, [&] (handlerton *hton)
     {
...
Sql_cmd_logfile_group(ts_command_type cmd_type,
		      ...
		      const Tablespace_options *options,
		      const LEX_STRING &undofile_name)
  : m_cmd(cmd_type),
...
bool Sql_cmd_logfile_group::execute(THD *thd)
{
  ...
  st_alter_tablespace ts_info{nullptr,
      m_logfile_group_name.str, m_cmd,
      TS_ALTER_TABLESPACE_TYPE_NOT_DEFINED, nullptr, m_undofile_name.str,
      *m_options};
