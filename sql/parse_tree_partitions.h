...
public:
  explicit PT_partition_comment(char *comment)
  : comment(comment)
  {}
...
public:
  PT_sub_partition_by_hash(bool is_linear,
                           const POS &hash_pos,
                           Item *hash,
...
public:
  PT_sub_partition_by_key(bool is_linear,
                          enum_key_algorithm key_algo,
                          List<char> *field_names,
                          const uint opt_num_subparts)
  : is_linear(is_linear),
...
protected:
  ...
  bool itemize_part_expr(Partition_parse_context *pc,
...
public:
  PT_part_type_def_key(bool is_linear,
                       enum_key_algorithm key_algo,
...
public:
  explicit PT_part_type_def_list_columns(List<char> *columns) : columns(columns)
  {}
...
public:
  PT_partition(PT_part_type_def *part_type_def,
               uint opt_num_parts,
