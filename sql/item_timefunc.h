...
class Item_func_time_to_sec final : public Item_int_func {
 public:
  ...
  bool resolve_type(THD *) override {
    param_type_is_default(0, 1, MYSQL_TYPE_TIME);
    fix_char_length(10);
    maybe_null = true;
    return false;
  }
...
class Item_typecast_date final : public Item_date_func {
 ...
 public:
  ...
  bool resolve_type(THD *thd) override {
    args[0]->propagate_type(MYSQL_TYPE_DATE, false, true);
    return Item_date_func::resolve_type(thd);
  }
  void print(const THD *thd, String *str,
             enum_query_type query_type) const override;
...
class Item_typecast_time final : public Item_time_func {
 ...
 public:
  ...
  bool resolve_type(THD *) override {
    args[0]->propagate_type(MYSQL_TYPE_DATETIME, false, true);
...
class Item_func_maketime final : public Item_time_func {
 public:
  ...
  bool resolve_type(THD *) override {
    param_type_is_default(0, 2, MYSQL_TYPE_LONGLONG);
    param_type_is_default(2, 3, MYSQL_TYPE_NEWDECIMAL);
    set_data_type_time(
