...
/*
  ...
  NOTE
    Unique names are generated by adding 'Name_exp_' to the old name of the
...
static void make_unique_view_field_name(Item *target, List<Item> &item_list,
  ...
  for (attempt = 0;; attempt++) {
    ...
    if (attempt)
      name_len = snprintf(buff, NAME_LEN, "Name_exp_%d_%s", attempt, name);
    else
      name_len = snprintf(buff, NAME_LEN, "Name_exp_%s", name);
