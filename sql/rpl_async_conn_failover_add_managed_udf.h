...
#ifndef RPL_ASYNC_CONN_FAILOVER_ADD_MANAGED_UDF_H
#define RPL_ASYNC_CONN_FAILOVER_ADD_MANAGED_UDF_H
...
class Rpl_async_conn_failover_add_managed : public Udf_service_impl {
  ...
  */
  static char *add_managed(UDF_INIT *init_id, UDF_ARGS *args, char *result,
  ...
  */
  static bool add_managed_init(UDF_INIT *init_id, UDF_ARGS *args,
                               char *message);
...
#endif /* RPL_ASYNC_CONN_FAILOVER_ADD_MANAGED_UDF_H */
