#ifndef GIS__SRS__SRS_H_INCLUDED
...
public:
  Geographic_srs() : m_semi_major_axis(NAN), m_inverse_flattening(NAN),
    m_prime_meridian(NAN), m_angular_unit(NAN)
  {
    for (int i= 0; i < 7; i++)
      m_towgs84[i]= NAN;
    for (int i= 0; i < 2; i++)
      m_axes[i]= Axis_direction::UNSPECIFIED;
  }

  virtual Srs_type srs_type() override
  {
    return Srs_type::GEOGRAPHIC;
  }
...
public:
  Popular_visualisation_pseudo_mercator_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_azimuthal_equal_area_spherical_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Equidistant_cylindrical_srs() : m_standard_parallel_1(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Equidistant_cylindrical_spherical_srs() : m_standard_parallel_1(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Krovak_north_orientated_srs() : m_latitude_of_center(NAN),
    m_longitude_of_center(NAN), m_azimuth(NAN),
    m_pseudo_standard_parallel_1(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Krovak_modified_srs() : m_latitude_of_center(NAN), m_longitude_of_center(NAN),
    m_azimuth(NAN), m_pseudo_standard_parallel_1(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN),
    m_evaluation_point_ordinate_1(NAN), m_evaluation_point_ordinate_2(NAN),
    m_c1(NAN), m_c2(NAN), m_c3(NAN), m_c4(NAN), m_c5(NAN), m_c6(NAN), m_c7(NAN),
    m_c8(NAN), m_c9(NAN), m_c10(NAN)
  {}
...
public:
  Krovak_modified_north_orientated_srs() : m_latitude_of_center(NAN),
    m_longitude_of_center(NAN), m_azimuth(NAN),
    m_pseudo_standard_parallel_1(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN),
    m_evaluation_point_ordinate_1(NAN), m_evaluation_point_ordinate_2(NAN),
...
public:
  Lambert_conic_conformal_2sp_michigan_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_standard_parallel_1(NAN),
    m_standard_parallel_2(NAN), m_false_easting(NAN), m_false_northing(NAN),
...
public:
  Colombia_urban_srs() : m_latitude_of_origin(NAN), m_longitude_of_origin(NAN),
    m_false_easting(NAN), m_false_northing(NAN),
...
public:
  Lambert_conic_conformal_1sp_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
...
public:
  Lambert_conic_conformal_2sp_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_standard_parallel_1(NAN),
    m_standard_parallel_2(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_conic_conformal_2sp_belgium_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_standard_parallel_1(NAN),
    m_standard_parallel_2(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Mercator_variant_a_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  Mercator_variant_b_srs() : m_standard_parallel_1(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Cassini_soldner_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Transverse_mercator_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  Transverse_mercator_south_orientated_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  Oblique_stereographic_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  Polar_stereographic_variant_a_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  New_zealand_map_grid_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Hotine_oblique_mercator_variant_a_srs() : m_latitude_of_center(NAN),
    m_longitude_of_center(NAN), m_azimuth(NAN), m_rectified_grid_angle(NAN),
    m_scale_factor(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Laborde_oblique_mercator_srs() : m_latitude_of_center(NAN),
    m_longitude_of_center(NAN), m_azimuth(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Hotine_oblique_mercator_variant_b_srs() : m_latitude_of_center(NAN),
    m_longitude_of_center(NAN), m_azimuth(NAN), m_rectified_grid_angle(NAN),
    m_scale_factor(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Tunisia_mining_grid_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_conic_near_conformal_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  American_polyconic_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Krovak_srs() : m_latitude_of_center(NAN), m_longitude_of_center(NAN),
    m_azimuth(NAN), m_pseudo_standard_parallel_1(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_azimuthal_equal_area_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Albers_equal_area_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_standard_parallel_1(NAN),
    m_standard_parallel_2(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Transverse_mercator_zoned_grid_system_srs() : m_latitude_of_origin(NAN),
    m_initial_longitude(NAN), m_zone_width(NAN), m_scale_factor(NAN),
    m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_conic_conformal_west_orientated_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_scale_factor(NAN), m_false_easting(NAN),
    m_false_northing(NAN)
  {}
...
public:
  Bonne_south_orientated_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Polar_stereographic_variant_b_srs() : m_standard_parallel(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Polar_stereographic_variant_c_srs() : m_standard_parallel(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Guam_projection_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Modified_azimuthal_equidistant_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Hyperbolic_cassini_soldner_srs() : m_latitude_of_origin(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_cylindrical_equal_area_spherical_srs() : m_standard_parallel_1(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
...
public:
  Lambert_cylindrical_equal_area_srs() : m_standard_parallel_1(NAN),
    m_longitude_of_origin(NAN), m_false_easting(NAN), m_false_northing(NAN)
  {}
