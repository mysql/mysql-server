...
BOOST_FUSION_ADAPT_STRUCT(
  ...
  (bool, valid)
  (gis::srs::wkt_parser::String, name)
  (gis::srs::wkt_parser::String, code)
)

BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Spheroid,
  (gis::srs::wkt_parser::String, name)
...
BOOST_FUSION_ADAPT_STRUCT(
  ...
  (gis::srs::wkt_parser::String, name)
  (gis::srs::wkt_parser::Spheroid, spheroid)
  (gis::srs::wkt_parser::Towgs84, towgs84)
  (gis::srs::wkt_parser::Authority, authority)
)
...
BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Axis,
  (gis::srs::wkt_parser::String, name)
  (gis::srs::Axis_direction, direction)
)

BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Twin_axes,
  (bool, valid)
  (gis::srs::wkt_parser::Axis, x)
  (gis::srs::wkt_parser::Axis, y)
)

BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Geographic_cs,
  (gis::srs::wkt_parser::String, name)
  (gis::srs::wkt_parser::Datum, datum)
  (gis::srs::wkt_parser::Prime_meridian, prime_meridian)
  (gis::srs::wkt_parser::Unit, angular_unit)
  (gis::srs::wkt_parser::Twin_axes, axes)
  (gis::srs::wkt_parser::Authority, authority)
)

BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Projection,
  (gis::srs::wkt_parser::String, name)
  (gis::srs::wkt_parser::Authority, authority)
)

BOOST_FUSION_ADAPT_STRUCT(
  gis::srs::wkt_parser::Projection_parameter,
  (gis::srs::wkt_parser::String, name),
  (double, value),
  (gis::srs::wkt_parser::Authority, authority)
)
...
BOOST_FUSION_ADAPT_STRUCT(
  ...
  (gis::srs::wkt_parser::String, name)
  (gis::srs::wkt_parser::Geographic_cs, geographic_cs)
  (gis::srs::wkt_parser::Projection, projection)
  (gis::srs::wkt_parser::Projection_parameters, parameters)
  (gis::srs::wkt_parser::Unit, linear_unit)
  (gis::srs::wkt_parser::Twin_axes, axes)
  (gis::srs::wkt_parser::Authority, authority)
)
...
struct Grammar : qi::grammar<Iterator, Coordinate_system(), Skipper>
{
  Grammar(char right_delimiter_char) : Grammar::base_type(start)
  {
    ...
    authority=
      qi::no_case[qi::lit("AUTHORITY")] >> qi::attr(true) >>
      left_delimiter >>
      quoted_string >>
      qi::lit(',') >>
      quoted_string >>
    ...
    spheroid=
      ...
      right_delimiter;
    to_wgs84=
      qi::no_case[qi::lit("TOWGS84")] >> qi::attr(true) >>
      left_delimiter >>
      number >> // dx
      qi::lit(',') >>
      number >> // dy
    ...
    axis_direction.add
      ...
      // matching.
      ("north", Axis_direction::NORTH)
      ("south", Axis_direction::SOUTH)
      ("east", Axis_direction::EAST)
      ("west", Axis_direction::WEST)
      ("other", Axis_direction::OTHER);
    axis=
      qi::no_case[qi::lit("AXIS")] >>
      left_delimiter >>
      quoted_string >>
      qi::lit(',') >>
      qi::no_case[axis_direction] >>
      right_delimiter;
    twin_axes=
      qi::attr(true) >>
      axis >>
