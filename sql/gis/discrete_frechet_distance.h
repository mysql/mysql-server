#ifndef GIS__DISCRETE_FRECHET_DISTANCE_H_INCLUDED
#define GIS__DISCRETE_FRECHET_DISTANCE_H_INCLUDED
...
/// my_error().
bool discrete_frechet_distance(const dd::Spatial_reference_system *srs,
                               const Geometry *g1, const Geometry *g2,
                               double *frechet_distance, bool *null) noexcept;

}  // namespace gis

#endif  // GIS__DISCRETE_FRECHET_DISTANCE_H_INCLUDED
