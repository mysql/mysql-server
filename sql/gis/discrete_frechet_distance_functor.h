#ifndef GIS__DISCRETE_FRECHET_DISTANCE_FUNCTOR_H_INCLUDED
#define GIS__DISCRETE_FRECHET_DISTANCE_FUNCTOR_H_INCLUDED
...
/// @file
///
/// This file declares the discrete_frechet_distance functor interface.
///
/// The functor is not intended for use directly by MySQL code. It should be
/// used indirectly through the gis::discrete_frechet_distance() function.
///
/// @see gis::discrete_frechet_distance
...
/// Discrete_frechet_distance functor that calls Boost.Geometry with the correct
/// parameter types.
///
/// The functor throws exceptions and is therefore only intended used to
/// implement discrete_frechet_distance or other geographic functions.
/// It should not be used directly by other MySQL code.
class Discrete_frechet_distance : public Functor<double> {
 private:
 ...
 public:
  Discrete_frechet_distance(double major, double minor);
...
#endif  // GIS__DISCRETE_FRECHET_DISTANCE_FUNCTOR_H_INCLUDED
