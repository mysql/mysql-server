...
public:
  ...
  */
  ...
  const char *enter_cond(THD *thd, const char *message, int n) const;
...
private:
  ...
  static const char *COND_MESSAGE_WAIT_FOR_DEAD_CLIENT;
  static const char *COND_MESSAGE_WAIT_FOR_VERY_OLD_CLIENT;
  static const char *COND_MESSAGE_WAIT_FOR_SQL_THREAD_NO_REPLICATION;
  /// Read-write lock that protects updates to the number of SIDs.
  mutable Checkable_rwlock *sid_lock;
