...
#include "sql/ha_ndbcluster_binlog.h"  // ndbcluster_binlog_setup_table
#include "sql/ndb_dd_client.h"         // Ndb_dd_client
#include "sql/ndb_dd_disk_data.h"  // ndb_dd_disk_data_get_object_id_and_version
#include "sql/ndb_dd_table.h"      // ndb_dd_table_get_object_id_and_version
#include "sql/ndb_log.h"           // ndb_log_*
#include "sql/ndb_ndbapi_util.h"   // ndb_logfile_group_exists
#include "sql/ndb_schema_dist.h"   // Ndb_schema_dist
#include "sql/ndb_table_guard.h"   // Ndb_table_guard
#include "sql/ndb_tdc.h"           // ndb_tdc_close_cached_table
#include "sql/ndb_thd.h"           // get_thd_ndb
