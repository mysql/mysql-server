...
Table_columns_view<F>::Table_columns_view(
    ...
    : Table_columns_view{Table_columns_view::default_filter} {}
...
Table_columns_view<F>::Table_columns_view(
    ...
    typename std::enable_if<std::is_same<
        U, std::function<bool(TABLE const *, size_t)>>::value>::type *)
    : Table_columns_view{table, Table_columns_view::default_filter} {}
...
typename Table_columns_view<F>::iterator Table_columns_view<F>::begin() {
  Table_columns_view<F>::iterator to_return{*this, -1, -1};
  ++to_return;
  return to_return;
}
...
typename Table_columns_view<F>::iterator Table_columns_view<F>::end() {
  Table_columns_view<F>::iterator to_return{
...
Table_columns_view<F> &Table_columns_view<F>::translate_bitmap(
  ...
  bitmap_init(&destination, nullptr, this->m_table->s->fields, false);
...
typename Table_columns_view<F>::iterator Table_columns_view<F>::iterator::
operator++(int) {
  Table_columns_view<F>::iterator to_return = (*this);
  ++(*this);
  return to_return;
}
...
typename Table_columns_view<F>::iterator::pointer
    Table_columns_view<F>::iterator::operator->() const {
  return this->Table_columns_view<F>::iterator::operator*();
}
...
template <typename F>
long Table_columns_view<F>::iterator::absolute_pos() {
  return this->m_absolute_pos;
}

template <typename F>
long Table_columns_view<F>::iterator::filtered_pos() {
  return this->m_filtered_pos;
}
