...
void init_sql_command_flags(void) {
  ...
  */
  ...
  sql_command_flags[SQLCOM_CREATE_USER_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_CREATE_OBJECT_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_DELETE_USER_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_DELETE_OBJECT_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_GRANT_USER_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_GRANT_OBJECT_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_REVOKE_USER_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  sql_command_flags[SQLCOM_REVOKE_OBJECT_ATTRIBUTE] =
      CF_CHANGES_DATA | CF_NEEDS_AUTOCOMMIT_OFF | CF_POTENTIAL_ATOMIC_DDL;
  ...
  */
  ...
  sql_command_flags[SQLCOM_DELETE_USER_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  sql_command_flags[SQLCOM_DELETE_OBJECT_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  sql_command_flags[SQLCOM_GRANT_USER_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  sql_command_flags[SQLCOM_GRANT_OBJECT_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  sql_command_flags[SQLCOM_REVOKE_USER_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  sql_command_flags[SQLCOM_REVOKE_OBJECT_ATTRIBUTE] |= CF_AUTO_COMMIT_TRANS;
  ...
  */
  ...
  sql_command_flags[SQLCOM_DELETE_USER_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  sql_command_flags[SQLCOM_DELETE_OBJECT_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  sql_command_flags[SQLCOM_GRANT_USER_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  sql_command_flags[SQLCOM_GRANT_OBJECT_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  sql_command_flags[SQLCOM_REVOKE_USER_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  sql_command_flags[SQLCOM_REVOKE_OBJECT_ATTRIBUTE] |= CF_DISALLOW_IN_RO_TRANS;
  ...
  */
  ...
  sql_command_flags[SQLCOM_DELETE_USER_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  sql_command_flags[SQLCOM_DELETE_OBJECT_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  sql_command_flags[SQLCOM_GRANT_USER_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  sql_command_flags[SQLCOM_GRANT_OBJECT_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  sql_command_flags[SQLCOM_REVOKE_USER_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  sql_command_flags[SQLCOM_REVOKE_OBJECT_ATTRIBUTE] |= CF_ALLOW_PROTOCOL_PLUGIN;
  ...
  */
  ...
  sql_command_flags[SQLCOM_DELETE_USER_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
  sql_command_flags[SQLCOM_DELETE_OBJECT_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
  sql_command_flags[SQLCOM_GRANT_USER_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
  sql_command_flags[SQLCOM_GRANT_OBJECT_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
  sql_command_flags[SQLCOM_REVOKE_USER_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
  sql_command_flags[SQLCOM_REVOKE_OBJECT_ATTRIBUTE] |= CF_REQUIRE_ACL_CACHE;
...
int mysql_execute_command(THD *thd, bool first_level) {
  ...
  */
  ...
  switch (lex->sql_command) {
    ...
    case SQLCOM_DELETE_USER_ATTRIBUTE:
    case SQLCOM_DELETE_OBJECT_ATTRIBUTE:
    case SQLCOM_GRANT_USER_ATTRIBUTE:
    case SQLCOM_GRANT_OBJECT_ATTRIBUTE:
    case SQLCOM_REVOKE_USER_ATTRIBUTE:
    case SQLCOM_REVOKE_OBJECT_ATTRIBUTE:
