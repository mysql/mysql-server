...
/**
  @page page_caching_sha2_authentication_exchanges Caching_sha2_password Message
  exchanges
  ...
  Case 2D : Authentication failure with full authentication - Plaintext
  connection AND Case 3D : Authentication failure with fast authentication -
