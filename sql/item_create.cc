...
static const std::pair<const char *, Create_func *> func_array[]=
{
  ...
  { "GET_DD_PARTITION_PRIVATE_DATA", SQL_FN_INTERNAL(Item_func_get_dd_partition_private_data, 2) },
  { "GET_DD_TABLESPACE_FILE_PRIVATE_DATA", SQL_FN_INTERNAL(Item_func_get_dd_tablespace_file_private_data, 2) },
