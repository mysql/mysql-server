...
static const std::pair<const char *, Create_func *> func_array[]=
{
  ...
  { "INTERNAL_TABLESPACE_ID",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_id, 3) },
  { "INTERNAL_TABLESPACE_TYPE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_type, 3) },
  { "INTERNAL_TABLESPACE_FREE_EXTENTS",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_free_extents, 3) },
  { "INTERNAL_TABLESPACE_TOTAL_EXTENTS",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_total_extents, 3) },
  { "INTERNAL_TABLESPACE_EXTENT_SIZE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_extent_size, 3) },
  { "INTERNAL_TABLESPACE_INITIAL_SIZE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_initial_size, 3) },
  { "INTERNAL_TABLESPACE_MAXIMUM_SIZE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_maximum_size, 3) },
  { "INTERNAL_TABLESPACE_AUTOEXTEND_SIZE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_autoextend_size, 3) },
  { "INTERNAL_TABLESPACE_DATA_FREE",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_data_free, 3) },
  { "INTERNAL_TABLESPACE_STATUS",
    SQL_FN_INTERNAL(Item_func_internal_tablespace_status, 3) }
};
