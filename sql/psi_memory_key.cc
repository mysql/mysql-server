...
static PSI_memory_info all_server_memory[] = {
    ...
    {&key_memory_host_cache_hostname, "host_cache::hostname", 0, 0,
     PSI_DOCUMENT_ME},
    ...
    {&key_memory_MYSQL_BIN_LOG_basename, "MYSQL_BIN_LOG::basename", 0, 0,
     PSI_DOCUMENT_ME},
    {&key_memory_MYSQL_BIN_LOG_index, "MYSQL_BIN_LOG::index", 0, 0,
     PSI_DOCUMENT_ME},
    {&key_memory_MYSQL_RELAY_LOG_basename, "MYSQL_RELAY_LOG::basename", 0, 0,
     PSI_DOCUMENT_ME},
    {&key_memory_MYSQL_RELAY_LOG_index, "MYSQL_RELAY_LOG::index", 0, 0,
     PSI_DOCUMENT_ME},
    ...
    {&key_memory_Event_scheduler_scheduler_param,
     "Event_scheduler::scheduler_param", 0, 0, PSI_DOCUMENT_ME},
    ...
    {&key_memory_global_system_variables, "global_system_variables", 0, 0,
     PSI_DOCUMENT_ME},
    ...
    {&key_memory_File_query_log_name, "File_query_log::name", 0, 0,
     PSI_DOCUMENT_ME},
