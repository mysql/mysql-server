...
extern MYSQL_PLUGIN_API CHARSET_INFO *files_charset_info ;
extern MYSQL_PLUGIN_API CHARSET_INFO *national_charset_info;
extern MYSQL_PLUGIN_API CHARSET_INFO *table_alias_charset;
...
extern MYSQL_PLUGIN_API int32 volatile connection_events_loop_aborted_flag;
...
extern MYSQL_PLUGIN_API ulong max_connections;
...
extern MYSQL_PLUGIN_API MY_TMPDIR mysql_tmpdir_list;
extern const char *show_comp_option_name[];
extern const char *first_keyword, *binary_keyword;
extern MYSQL_PLUGIN_API const char  *my_localhost;
...
extern "C" MYSQL_PLUGIN_API int orig_argc;
extern "C" MYSQL_PLUGIN_API char **orig_argv;
...
extern MYSQL_PLUGIN_LEGACY_API PSI_stage_info stage_connecting_to_master;
...
extern MYSQL_PLUGIN_LEGACY_API PSI_stage_info stage_executing;
...
extern MYSQL_PLUGIN_LEGACY_API PSI_stage_info stage_suspending;
...
extern MYSQL_PLUGIN_API char reg_ext[FN_EXTLEN];
extern MYSQL_PLUGIN_API uint reg_ext_length;
extern MYSQL_PLUGIN_API uint lower_case_table_names;
...
extern MYSQL_PLUGIN_API char  *mysql_data_home;
extern "C" MYSQL_PLUGIN_API char server_version[SERVER_VERSION_LENGTH];
extern MYSQL_PLUGIN_API char mysql_real_data_home[];
extern char mysql_unpacked_real_data_home[];
extern MYSQL_PLUGIN_API struct System_variables global_system_variables;
