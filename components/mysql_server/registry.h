...
public:
  ...
  */
  ...
  /**
    ...
    @retval true failure
  */
  static bool register_service_nolock(
...
public: /* Service Implementations */
  /**
    ...
    @retval true failure
  */
  static DEFINE_BOOL_METHOD(acquire,
    (const char *service_name, my_h_service *out_service));
  ...
  */
  ...
  /**
    ...
    @retval true failure
  */
  static DEFINE_BOOL_METHOD(release,
...
private:
  ...
  */
  static mysql_service_implementation*
    get_service_implementation_by_interface(my_h_service interface);
};
