...
#ifndef APPLIER_METRICS_PFS_TABLE_H
#define APPLIER_METRICS_PFS_TABLE_H
...
///
/// @return pointer to a statically allocated PFS_engine_table_share_proxy
/// object.
PFS_engine_table_share_proxy *get_applier_metrics_table_share();

}  // namespace applier_metrics

#endif /* APPLIER_METRICS_PFS_TABLE_H */
