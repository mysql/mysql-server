...
/**
  ...
  the service.
*/
static mysql_service_status_t test_component_status_var_service_unreg_init() {
  ...
  if (mysql_service_status_variable_registration->unregister_variable(
          (SHOW_VAR *)&str_variable)) {
    WRITE_LOG("%s\n", "str unregister_variable failed.");
  }
...
*/
static mysql_service_status_t test_component_status_var_service_unreg_deinit() {
  return false;
}
...
test_component_status_var_service_unreg_init,
    test_component_status_var_service_unreg_deinit END_DECLARE_COMPONENT();
