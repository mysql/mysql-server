...
*/
static STATUS_VAR status_int_var[]=
{
  {"test_component.int_var", (char *) &int_variable_value,
   SHOW_INT, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_bool_var[]=
{
  {"test_component.bool_var", (char *) &bool_variable_value,
   SHOW_BOOL, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_long_var[]=
{
  {"test_component.long_var", (char *) &long_variable_value,
   SHOW_LONG, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_longlong_var[]=
{
  {"test_component.longlong_var", (char *) &longlong_variable_value,
   SHOW_LONGLONG, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_char_var[]=
{
  {"test_component.char_var", (char *) &char_variable_value,
   SHOW_CHAR, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_char_ptr_var[]=
{
  {"test_component.char_ptr_var", (char *) &char_ptr_variable_value,
   SHOW_CHAR_PTR, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_double_var[]=
{
  {"test_component.double_var", (char *) &double_variable_value,
   SHOW_DOUBLE, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};

static int show_func_example(THD *, struct st_mysql_show_var *var,
                             char *buf)
{
  var->type= SHOW_CHAR;
  var->value= buf;
  snprintf(buf, 100,
           "Testing SHOW_FUNC type for component status variables");
  return 0;
}
static STATUS_VAR status_func_var[]=
{
  {"test_component.func_var", (char *) show_func_example,
...
static STATUS_VAR array_value[]=
{
  {"var1", (char *) &example_vars.var1,
   SHOW_CHAR, SHOW_SCOPE_GLOBAL},
  {"var2", (char *) &example_vars.var2,
   SHOW_DOUBLE, SHOW_SCOPE_GLOBAL},
  {0, 0, SHOW_UNDEF, SHOW_SCOPE_UNDEF} // null terminator required
};
static STATUS_VAR status_array_var[]=
{
  {"test_component.array", (char *) array_value,
