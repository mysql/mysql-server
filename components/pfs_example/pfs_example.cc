...
static void test_psi_rwlock_part_1()
{
  ...
  {
    locker = PSI_RWLOCK_CALL(start_rwlock_rdwait)(& state, psi_rwlock_s1, PSI_RWLOCK_SHAREDLOCK, "HERE", 12);
    if (locker != NULL)
    {
  ...
  {
    locker = PSI_RWLOCK_CALL(start_rwlock_wrwait)(& state, psi_rwlock_s2, PSI_RWLOCK_EXCLUSIVELOCK, "THERE", 13);
    if (locker != NULL)
    {
