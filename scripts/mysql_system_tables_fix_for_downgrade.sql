...
ALTER TABLE `columns_priv` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
ALTER TABLE `db` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
...
ALTER TABLE `procs_priv` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
ALTER TABLE `proxies_priv` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
...
ALTER TABLE `tables_priv` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
...
ALTER TABLE `user` ENGINE=MyISAM STATS_PERSISTENT=DEFAULT;
