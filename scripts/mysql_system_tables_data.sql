...
REPLACE INTO tmp_user SELECT LOWER(@current_hostname),'root','','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','','','','',0,0,0,0,@@default_authentication_plugin,'','N' FROM dual WHERE LOWER( @current_hostname) != 'localhost';
...
INSERT INTO tmp_user (host,user) SELECT LOWER(@current_hostname),'' FROM dual WHERE LOWER(@current_hostname ) != 'localhost';
