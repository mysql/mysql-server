...
PSI_mutex_key key_GR_LOCK_applier_module_run,
    ...
    key_GR_LOCK_group_part_handler_run, key_GR_LOCK_group_part_handler_abort,
    key_GR_LOCK_view_modification_wait, key_GR_LOCK_group_info_manager,
    key_GR_LOCK_pipeline_continuation, key_GR_LOCK_synchronized_queue,
    key_GR_LOCK_count_down_latch, key_GR_LOCK_wait_ticket,
    ...
    key_GR_LOCK_plugin_running, key_GR_LOCK_force_members_running,
    key_GR_LOCK_write_lock_protection, key_GR_LOCK_pipeline_stats_flow_control,
    key_GR_LOCK_pipeline_stats_transactions_waiting_apply,
    key_GR_LOCK_trx_unlocking, key_GR_LOCK_plugin_online,
    key_GR_LOCK_channel_observation_removal;

PSI_cond_key key_GR_COND_applier_module_run, key_GR_COND_applier_module_suspend,
    key_GR_COND_applier_module_wait, key_GR_COND_cert_broadcast_run,
    key_GR_COND_cert_broadcast_dispatcher_run, key_GR_COND_delayed_init_run,
    key_GR_COND_delayed_init_server_ready, key_GR_COND_group_part_handler_run,
    key_GR_COND_group_part_handler_abort, key_GR_COND_view_modification_wait,
    key_GR_COND_pipeline_continuation, key_GR_COND_synchronized_queue,
    key_GR_COND_count_down_latch, key_GR_COND_wait_ticket,
    key_GR_COND_recovery_module_run, key_GR_COND_recovery,
    key_GR_COND_session_thread_method_exec, key_GR_COND_session_thread_run,
    key_GR_COND_pipeline_stats_flow_control, key_GR_COND_write_lock_protection,
    key_GR_COND_plugin_online;

PSI_thread_key key_GR_THD_applier_module_receiver, key_GR_THD_cert_broadcast,
    key_GR_THD_delayed_init, key_GR_THD_plugin_session,
    key_GR_THD_group_partition_handler, key_GR_THD_recovery;
...
static PSI_cond_info all_group_replication_psi_condition_keys[] = {
    ...
    {&key_GR_COND_delayed_init_server_ready, "COND_delayed_init_server_ready",
     PSI_FLAG_SINGLETON, 0, PSI_DOCUMENT_ME},
    {&key_GR_LOCK_group_part_handler_run, "COND_group_part_handler_run",
     PSI_FLAG_SINGLETON, 0, PSI_DOCUMENT_ME},
    {&key_GR_LOCK_group_part_handler_abort, "COND_group_part_handler_abort",
     PSI_FLAG_SINGLETON, 0, PSI_DOCUMENT_ME},
