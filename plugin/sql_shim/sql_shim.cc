/*  Copyright (c) 2015, Oracle and/or its affiliates. All rights reserved.
    ...
    02110-1301  USA */
#define MYSQL_SERVER
#include <mysql/plugin_sqlshim.h>
#include <sql/sql_class.h>
#include <locale>
#include <sql/sql_client.h>

static bool query_injection_point(
...
static bool query_injection_point(THD* thd, COM_DATA *com_data, enum enum_server_command command, 
                           COM_DATA* new_com_data, enum enum_server_command* new_command) 
{
