...
#ifndef PLUGIN_X_SRC_INTERFACE_SHA256_PASSWORD_CACHE_H_
#define PLUGIN_X_SRC_INTERFACE_SHA256_PASSWORD_CACHE_H_
...
class SHA256_password_cache {
 public:
  ...
  virtual ~SHA256_password_cache() = default;
};

}  // namespace iface
}  // namespace xpl

#endif  // PLUGIN_X_SRC_INTERFACE_SHA256_PASSWORD_CACHE_H_
