...
#ifndef PLUGIN_X_SRC_NGS_PROTOCOL_PROTOCOL_PROTOBUF_H_
#define PLUGIN_X_SRC_NGS_PROTOCOL_PROTOCOL_PROTOBUF_H_
...
#endif  // PLUGIN_X_SRC_NGS_PROTOCOL_PROTOCOL_PROTOBUF_H_
