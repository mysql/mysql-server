...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_PROTOCOL_CONST_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_PROTOCOL_CONST_H_
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_PROTOCOL_CONST_H_
