...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_CAPABILITIES_HANDLER_TLS_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_CAPABILITIES_HANDLER_TLS_H_
...
class Capability_tls : public Capability_handler {
 public:
  Capability_tls(Client_interface &client)
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_CAPABILITIES_HANDLER_TLS_H_
