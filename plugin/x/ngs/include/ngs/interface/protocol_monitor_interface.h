...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_INTERFACE_PROTOCOL_MONITOR_INTERFACE_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_INTERFACE_PROTOCOL_MONITOR_INTERFACE_H_
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_INTERFACE_PROTOCOL_MONITOR_INTERFACE_H_
