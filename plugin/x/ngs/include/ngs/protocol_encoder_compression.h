...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODER_COMPRESSION_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODER_COMPRESSION_H_
...
class Protocol_encoder_compression : public Protocol_encoder_interface {
 public:
  using Protocol_encoder_ptr =
      ngs::Memory_instrumented<Protocol_encoder_interface>::Unique_ptr;
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODER_COMPRESSION_H_
