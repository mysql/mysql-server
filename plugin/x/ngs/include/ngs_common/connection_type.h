...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_COMMON_CONNECTION_TYPE_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_COMMON_CONNECTION_TYPE_H_
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_COMMON_CONNECTION_TYPE_H_
