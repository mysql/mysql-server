...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_COMMON_OPERATIONS_FACTORY_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_COMMON_OPERATIONS_FACTORY_H_
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_COMMON_OPERATIONS_FACTORY_H_
