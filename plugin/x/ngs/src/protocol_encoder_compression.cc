...
Protocol_encoder_compression::Protocol_encoder_compression(
    Protocol_encoder_ptr encoder, Protocol_monitor_interface *monitor,
...
bool Protocol_encoder_compression::send_notice(const Frame_type type,
...
Protocol_monitor_interface &
Protocol_encoder_compression::get_protocol_monitor() {
  return m_encoder->get_protocol_monitor();
}

void Protocol_encoder_compression::set_comp_algo(
    const Compression_algorithm algo) {
  get_comp_flusher()->set_comp_algo(algo);
}

void Protocol_encoder_compression::set_comp_style(
    const Compression_style style) {
  get_comp_flusher()->set_comp_style(style);
}
