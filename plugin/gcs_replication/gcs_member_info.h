...
public:
   ...
   */
  uint encode(vector<uchar>* mbuf_ptr);
   ...
   */
  string get_textual_representation();
...
public:
   ...
   */
  virtual Cluster_member_info* get_cluster_member_info(string uuid)= 0;
   ...
   */
  virtual vector<Cluster_member_info*>* get_all_members()= 0;
   ...
   */
  virtual void update(vector<Cluster_member_info*>* new_members)= 0;
   ...
   */
  virtual void update_member_status(string uuid,
   ...
   */
  virtual void encode(vector<uchar>* to_encode)= 0;
   ...
   */
  virtual vector<Cluster_member_info*>* decode(uchar* to_decode)= 0;
   ...
   */
  virtual vector<uchar>* get_exchangeable_format()= 0;
};
...
public:
  ...
  Cluster_member_info* get_cluster_member_info(string uuid);
  ...
  vector<Cluster_member_info*>* get_all_members();

  void add(Cluster_member_info* new_member);

  void update(vector<Cluster_member_info*>* new_members);

  void update_member_status(string uuid,
                            Cluster_member_info::Cluster_member_status
                                                                   new_status);

  void encode(vector<uchar>* to_encode);

  vector<Cluster_member_info*>* decode(uchar* to_decode);

  vector<uchar>* get_exchangeable_format();

private:
  void clear_members();

  map<string, Cluster_member_info*> *members;
   ...
   */
  vector<uchar> *serialized_format;
