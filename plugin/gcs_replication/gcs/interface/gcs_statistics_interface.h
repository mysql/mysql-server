...
public:
  ...
  /**
    @return the total number of messages received via the Communication Interface
  ...
  */
  ...
  /**
    @return the smallest amount of data received in a message
            via the Communication Interface public event interface.
  */
  virtual long get_min_message_length()= 0;

  /**
    @return the biggest amount of data received in a message
            via the Communication Interface public event interface.
  */
