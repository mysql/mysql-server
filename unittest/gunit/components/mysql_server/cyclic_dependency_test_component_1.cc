...
greetings_localization_imp::get_language,
    END_SERVICE_IMPLEMENTATION()
        ...
        BEGIN_COMPONENT_PROVIDES(cyclic_dependency_test_component_1)
            PROVIDES_SERVICE(cyclic_dependency_test_component_1,
                             greetings_localization) END_COMPONENT_PROVIDES()

                BEGIN_COMPONENT_METADATA(cyclic_dependency_test_component_1)
                    END_COMPONENT_METADATA()

                        DECLARE_COMPONENT(
                            cyclic_dependency_test_component_1,
                            "mysql:cyclic_dependency_test_component_1") NULL,
    NULL END_DECLARE_COMPONENT()

        DECLARE_LIBRARY_COMPONENTS &COMPONENT_REF(
            cyclic_dependency_test_component_1) END_DECLARE_LIBRARY_COMPONENTS
