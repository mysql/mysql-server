...
#ifndef UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_FILE_H_
#define UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_FILE_H_
...
class File : public iface::File {
 public:
  ...
  MOCK_METHOD(int, fsync, (), (override));
};
...
#endif  // UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_FILE_H_
