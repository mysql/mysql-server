...
static void BM_Chinese_Traditional_AS_CS(size_t num_iterations) {
  StopBenchmarkTiming();

  CHARSET_INFO *cs = init_collation("utf8mb4_zh_trad_0900_as_cs");
  const char *content =
      "春江潮水连海平，海上明月共潮生。"
      "滟滟随波千万里，何处春江无月明！"
      "江流宛转绕芳甸，月照花林皆似霰；"
  ...
  // Just recorded from a trial run on the string above.
  static constexpr uchar expected[] = {
      ,
...
BENCHMARK(BM_Chinese_Traditional_AS_CS)
...
TEST(StrmxfrmHashTest, HashStability) {
  ...
  unordered_map<string, GoldenHashResult> expected = {
      ...
      {"utf8mb4_zh_trad_0900_as_cs", {{0x8d51bef7b61fa3f7LL, 0x00000001LL}}},
  };
...
TEST(StrXfrmTest, LoadAndUnloadChineseTraditional) {
  for (int i = 0; i < 10; ++i) {
    CHARSET_INFO *csa = init_collation("utf8mb4_zh_trad_0900_as_cs");
    EXPECT_NE(csa, nullptr);
    charset_uninit();
    CHARSET_INFO *csb = init_collation("utf8mb4_zh_trad_0900_as_cs");
    EXPECT_NE(csb, nullptr);
  }
}
