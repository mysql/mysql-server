...
TEST(StrXfrmTest, JapaneseUTF8MB4)
{
  ...
  static const unsigned char full_answer_with_pad[156]= {
    ...
    0x00, 0x02, 0x00, 0x0E, 0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02,             // Japanese Han
...
TEST(StrXfrmTest, Japanese_ks_UTF8MB4)
{
  ...
  */
  ...
  static const unsigned char full_answer_with_pad[]= {
    ...
    0xFB, 0x86, 0x1F, 0xE6, 0xFB, 0x86, 0x1F, 0xF0,
    0xFB, 0x86, 0x3D, 0x59,
    0x1F, 0xC1, 0x1F, 0xB6, 0x1F, 0xC1, 0x1F, 0xB6, // Prefix context
    0x00, 0x00,                                     // Level separator
                                                    // Level 2
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, // latin
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, // Hiragana and Katakana
    ...
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, // Greek, Coptic etc.
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, // Prefix context
    0x00, 0x00,                                     // Level separator
                                                    // Level 3
    0x00, 0x02, 0x00, 0x08, 0x00, 0x02, 0x00, 0x02, // latin
    0x00, 0x0D, 0x00, 0x0E, 0x00, 0x0E, 0x00, 0x0E, // Hiragana and Katakana
    ...
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x04, // Greek, Coptic etc.
    0x00, 0x04, 0x00, 0x04, 0x00, 0x02,
    0x00, 0x0E, 0x00, 0x0C, 0x00, 0x21, 0x00, 0x0E, // Prefix context
    0x00, 0x0C, 0x00, 0x21,
    0x00, 0x00,                                     // Level separator
                                                    // Level 4
    0x00, 0x02, 0x00, 0x08, 0x00, 0x02, 0x00, 0x02, // Hiragana and Katakana
    0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x08, 0x00, 0x08  // Prefix context
  };
...
TEST(StrXfrmTest, JapaneseUTF8MB4_1)
{
  ...
  */
  static const unsigned char answer1[]= {
    0x1F, 0xD3, 0x00, 0x00, 0x00, 0x20, 0x00, 0x37,
    0x00, 0x00, 0x00, 0x0E, 0x00, 0x02
  };
  static const unsigned char answer2[]= {
    0x1F, 0xD3, 0x1F, 0xD3, 0x00, 0x00, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x37, 0x00, 0x00, 0x00, 0x0E,
    0x00, 0x0E, 0x00, 0x01, 0x00, 0x21
  };
  ...
  memset(buf, 0xff, sizeof(buf));
  my_strnxfrm(
    cs, buf, buf_len, pointer_cast<const uchar *>(src1), strlen(src1));
  expect_arrays_equal(answer1, buf, buf_len);

  buf_len= sizeof(answer2);
  memset(buf, 0xff, sizeof(buf));
  my_strnxfrm(
    cs, buf, buf_len, pointer_cast<const uchar *>(src2), strlen(src2));
...
TEST(StrXfrmTest, UTF8MB4PadCorrectness)
{
  ...
  static const unsigned char full_answer[52] = {
    0x1c, 0x47, 0x1c, 0x60, 0x1c, 0x7a,  // abc
    0x02, 0x09, 0x02, 0x09, 0x02, 0x09, 0x02, 0x09,  // Four spaces.
    0x00, 0x00,  // Level separator.
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20,  // Accents for abc.
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,  // Accents for four spaces.
    0x00, 0x00,  // Level separator.
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02,  // Case for abc.
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02,  // Case for four spaces.
  };
...
static void BM_MixedUTF8MB4_AS_CI(size_t num_iterations)
{
  ...
  static constexpr uchar expected[]= {
    ...
    0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
    0x20, 0x00, 0x29, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
    0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
    0x20, 0x00, 0x2F, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x01, 0x10, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
    0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x37, 0x00, 0x20, 0x00,
    0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00,
...
static void BM_MixedUTF8MB4_AS_CS(size_t num_iterations)
{
  ...
  static constexpr uchar expected[]= {
    ...
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x29, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x2f, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x01, 0x10, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
    0x00, 0x20, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20,
...
static void BM_NewlineFilledUTF8MB4(size_t num_iterations)
{
  ...
  static constexpr uchar expected[]= {
    
  };
  uchar dest[sizeof(expected)];
...
static void BM_Hungarian_AS_CS(size_t num_iterations)
{
  ...
  // Just recorded from a trial run on the string above.
  static constexpr uchar expected[]= {
    0x1c, 0x47, 0x02, 0x09, 0x1d, 0xaa, 0x1f, 0x0b,
    0x1e, 0x71, 0x1e, 0x21, 0x1d, 0x77, 0x02, 0x09,
    0x1c, 0x47, 0x1c, 0x8f, 0x1c, 0x47, 0x1e, 0x95,
    0x1c, 0x60, 0x1c, 0x47, 0x1f, 0x21, 0x1d, 0x32,
    0x1e, 0x71, 0x1d, 0xdd, 0x1d, 0x65, 0x02, 0x09,
    ...
    ,
    ...
    0x00, 0x02, 0x00, 0x08, 0x00, 0x02, 0x00, 0x08,
    0x00, 0x08, 0x00, 0x08, 0x00, 0x02, 0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02,
    0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02,
...
static void BM_Japanese_AS_CS(size_t num_iterations)
{
  ...
  CHARSET_INFO *cs= init_collation("utf8mb4_ja_0900_as_cs");
  const char *content= "サーバー SQL モードの設定方法。この設定は、たとえば"
  ...
  // Just recorded from a trial run on the string above.
  static constexpr uchar expected[]= {
    ,
    ...
    
...
static void BM_Japanese_AS_CS_KS(size_t num_iterations)
{
  ...
  // Just recorded from a trial run on the string above.
  static constexpr uchar expected[]= {
    ,
    ...
    
  };
  uchar dest[sizeof(expected)];
