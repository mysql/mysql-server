...
#ifndef EVENT_TRACKING_PARSE_CONSUMER_HELPER_H
#define EVENT_TRACKING_PARSE_CONSUMER_HELPER_H
...
/**
  @file event_tracking_parse_consumer_helper.h
  Helper file to create parse event consumer
*/

// clang-format off
/**
  @anchor EVENT_TRACKING_PARSE_CONSUMER_EXAMPLE
  ...
  IMPLEMENTS_SERVICE_EVENT_TRACKING_PARSE(<implementation_name>);

  BEGIN_COMPONENT_PROVIDES(<component_name>)
  PROVIDES_SERVICE_EVENT_TRACKING_PARSE(<implementation_name>)
...
#define PROVIDES_SERVICE_EVENT_TRACKING_PARSE(component) \
  PROVIDES_SERVICE(component, event_tracking_parse)
...
namespace Event_tracking_implementation {
/** Implementation helper class for parse events. */
class Event_tracking_parse_implementation {
 public:
  ...
  /**
    event_tracking_parse service implementation

    @param [in] data  Data related to parse event
...
#endif  // !EVENT_TRACKING_PARSE_CONSUMER_HELPER_H
