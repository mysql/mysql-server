...
#ifndef EVENT_TRACKING_MESSAGE_CONSUMER_HELPER_H
#define EVENT_TRACKING_MESSAGE_CONSUMER_HELPER_H
...
/**
  @file event_tracking_message_consumer_helper.h
  Helper file to create message event consumer
*/

// clang-format off
/**
  @anchor EVENT_TRACKING_MESSAGE_CONSUMER_EXAMPLE
  ...
  IMPLEMENTS_SERVICE_EVENT_TRACKING_MESSAGE(<implementation_name>);

  BEGIN_COMPONENT_PROVIDES(<component_name>)
  PROVIDES_SERVICE_EVENT_TRACKING_MESSAGE(<implementation_name>)
...
#define PROVIDES_SERVICE_EVENT_TRACKING_MESSAGE(component) \
  PROVIDES_SERVICE(component, event_tracking_message)
...
namespace Event_tracking_implementation {
/** Implementation helper class for message events. */
class Event_tracking_message_implementation {
 public:
  ...
  /**
    event_tracking_message service implementation

    @param [in] data  Data related to message event
...
#endif  // !EVENT_TRACKING_MESSAGE_CONSUMER_HELPER_H
