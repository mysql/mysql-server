...
#ifndef EVENT_TRACKING_AUTHENTICATION_CONSUMER_HELPER_H
#define EVENT_TRACKING_AUTHENTICATION_CONSUMER_HELPER_H
...
/**
  @file event_tracking_authentication_consumer_helper.h
  Helper file to create authentication event consumer
*/

// clang-format off
/**
  @anchor EVENT_TRACKING_AUTHENTICATION_CONSUMER_EXAMPLE
  ...
  IMPLEMENTS_SERVICE_EVENT_TRACKING_AUTHENTICATION(<implementation_name>);

  BEGIN_COMPONENT_PROVIDES(<component_name>)
  PROVIDES_SERVICE_EVENT_TRACKING_AUTHENTICATION(<implementation_name>)
...
#define PROVIDES_SERVICE_EVENT_TRACKING_AUTHENTICATION(component) \
  PROVIDES_SERVICE(component, event_tracking_authentication)

#define IMPLEMENTS_SERVICE_EVENT_TRACKING_AUTHENTICATION(component)      \
  BEGIN_SERVICE_IMPLEMENTATION(component, event_tracking_authentication) \
  Event_tracking_implementation::                                        \
      Event_tracking_authentication_implementation::notify               \
      END_SERVICE_IMPLEMENTATION()

namespace Event_tracking_implementation {
/** Implementation helper class for authentication events. */
class Event_tracking_authentication_implementation {
 public:
  ...
  /**
    event_tracking_authentication service implementation

    @param [in] data  Data related to authentication event
...
#endif  // !EVENT_TRACKING_AUTHENTICATION_CONSUMER_HELPER_H
