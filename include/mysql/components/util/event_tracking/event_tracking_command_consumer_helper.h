...
#ifndef EVENT_TRACKING_COMMAND_CONSUMER_HELPER_H
#define EVENT_TRACKING_COMMAND_CONSUMER_HELPER_H
...
/**
  @file event_tracking_command_consumer_helper.h
  Helper file to create command event consumer
*/

// clang-format off
/**
  @anchor EVENT_TRACKING_COMMAND_CONSUMER_EXAMPLE
  ...
  IMPLEMENTS_SERVICE_EVENT_TRACKING_COMMAND(<implementation_name>);

  BEGIN_COMPONENT_PROVIDES(<component_name>)
  PROVIDES_SERVICE_EVENT_TRACKING_COMMAND(<implementation_name>)
...
#define PROVIDES_SERVICE_EVENT_TRACKING_COMMAND(component) \
  PROVIDES_SERVICE(component, event_tracking_command)

#define IMPLEMENTS_SERVICE_EVENT_TRACKING_COMMAND(component)                   \
  BEGIN_SERVICE_IMPLEMENTATION(component, event_tracking_command)              \
  Event_tracking_implementation::Event_tracking_command_implementation::notify \
  END_SERVICE_IMPLEMENTATION()

namespace Event_tracking_implementation {
/** Implementation helper class for command events. */
class Event_tracking_command_implementation {
 public:
  ...
  /**
    event_tracking_command service implementation

    @param [in] data  Data related to command event
...
#endif  // !EVENT_TRACKING_COMMAND_CONSUMER_HELPER_H
