...
BEGIN_SERVICE_DEFINITION(dynamic_loader_query)
  ...
  */
  DECLARE_BOOL_METHOD(get,
    (my_h_component_iterator iter, const char **out_name,
      const char **out_urn));
  /**
...
BEGIN_SERVICE_DEFINITION(dynamic_loader_metadata_enumerate)
  ...
  */
  DECLARE_BOOL_METHOD(get,
    (my_h_component_metadata_iterator iterator, const char **name,
      const char **value));
  /**
  ...
  */
  DECLARE_BOOL_METHOD(next,
    (my_h_component_metadata_iterator iterator));
  /**
    Checks if specified iterator is valid, i.e. have not reached one-past-last
    element.
...
BEGIN_SERVICE_DEFINITION(dynamic_loader_metadata_query)
  /**
    ...
    @retval true Failure, may be caused when called on the iterator that went
      through all values already.
  */
  DECLARE_BOOL_METHOD(get_value,
    (my_h_component_iterator iterator, const char *name, const char **value));
