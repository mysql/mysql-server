...
#ifndef COMPONENTS_SERVICES_EVENT_TRACKING_TABLE_ACCESS_SERVICE_H
#define COMPONENTS_SERVICES_EVENT_TRACKING_TABLE_ACCESS_SERVICE_H

#include "mysql/components/service.h"
#include "mysql/components/services/defs/event_tracking_table_access_defs.h"

/**
  @file mysql/components/services/event_tracking_table_access_service.h
...
/**
  ...
  @anchor EVENT_TRACKING_TABLE_ACCESS_SERVICE
...
BEGIN_SERVICE_DEFINITION(event_tracking_table_access)
...
END_SERVICE_DEFINITION(event_tracking_table_access)

#endif  // COMPONENTS_SERVICES_EVENT_TRACKING_TABLE_ACCESS_SERVICE_H
