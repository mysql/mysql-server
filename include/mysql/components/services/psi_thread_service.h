...
/*
  ...
  built against headers from MySQL 8.0.3 -- 8.0.14
*/
...
BEGIN_SERVICE_DEFINITION(psi_thread_v2)
/** @sa register_thread_v1_t. */
register_thread_v1_t register_thread;
/** @sa spawn_thread_v1_t. */
spawn_thread_v1_t spawn_thread;
...
/** @sa notify_session_change_user_v1_t. */
notify_session_change_user_v1_t notify_session_change_user;
END_SERVICE_DEFINITION(psi_thread_v2)

#define REQUIRES_PSI_THREAD_SERVICE REQUIRES_SERVICE(psi_thread_v2)
