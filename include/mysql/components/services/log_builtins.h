...
BEGIN_SERVICE_DEFINITION(log_builtins)
  ...
  */
  ...
  /**
    ...
    @retval false  all's well
  */
  DECLARE_METHOD(bool,  item_set_lexstring, (log_item_data *lid,
  ...
  /**
    ...
    @retval false  all's well
  */
  DECLARE_METHOD(bool,  item_set_cstring,   (log_item_data *lid,
                                             const char *s));
  ...
  */
  ...
  /**
    ...
    @retval        a pointer to the log_item's log_data, for easy chaining:
                   log_item_set_with_key(...)->data_integer= 1;
  */
  DECLARE_METHOD(log_item_data *,  item_set,
                                     (log_item *li, log_item_type t));
  ...
  */
  DECLARE_METHOD(void,             line_item_iter_release,
                                                    (log_item_iter *it));
  /**
  ...
  */
  ...
  /**
    ...
    @retval     !0             failure
  */
  DECLARE_METHOD(int,              open_errstream,  (const char *file,
                                                     void **my_errstream));
  ...
  /**
    ...
    @retval !0                 failure
  */
  DECLARE_METHOD(int,              write_errstream, (void *my_errstream,
                                                     const char *buffer,
                                                     size_t length));
...
BEGIN_SERVICE_DEFINITION(log_builtins_syseventlog)
  ...
  DECLARE_METHOD(int,              write, (enum loglevel level,
                                           const char *msg));
...
public:
  ...
  */
  ...
  {
    log_set_int(log_line_item_set_with_key(this->ll,
                                           LOG_ITEM_GEN_INTEGER,
                                           key, LOG_ITEM_FREE_NONE),
                     val);
    return *this;
  }
  ...
  */
  ...
  {
    log_set_float(log_line_item_set_with_key(this->ll,
                                             LOG_ITEM_GEN_FLOAT,
                                             key, LOG_ITEM_FREE_NONE),
                  val);
    return *this;
  ...
  */
  ...
  {
    log_set_lexstring(log_line_item_set_with_key(this->ll,
  ...
  */
  ...
  {
    log_set_cstring(log_line_item_set_with_key(this->ll,
                                               LOG_ITEM_GEN_LEX_STRING,
                                               key, LOG_ITEM_FREE_NONE),
                    val);
    return *this;
