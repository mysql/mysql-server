...
BEGIN_SERVICE_DEFINITION(mysql_string_character_access)
  ...
  */
  ...
  /**
    ...
    @retval true failure
  */
  DECLARE_BOOL_METHOD(get_char_length,
...
BEGIN_SERVICE_DEFINITION(mysql_string_byte_access)
  ...
  */
  ...
  /**
    ...
    @retval true failure
  */
  DECLARE_BOOL_METHOD(get_byte_length,
    (my_h_string string, uint* out_length));
...
BEGIN_SERVICE_DEFINITION(mysql_string_iterator)
  ...
  */
  ...
  /**
    ...
    @retval true failure
  */
  DECLARE_METHOD(void, iterator_destroy,
