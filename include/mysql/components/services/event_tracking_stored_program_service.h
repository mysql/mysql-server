...
#ifndef MYSQL_COMPONENTS_SERVICES_EVENT_TRACKING_STORED_PROGRAM_SERVICE_H
#define MYSQL_COMPONENTS_SERVICES_EVENT_TRACKING_STORED_PROGRAM_SERVICE_H

#include "mysql/components/service.h"
#include "mysql/components/services/defs/event_tracking_stored_program_defs.h"

/**
  @file mysql/components/services/event_tracking_stored_program_service.h
...
/**
  ...
  @anchor EVENT_TRACKING_STORED_PROGRAM_SERVICE
...
BEGIN_SERVICE_DEFINITION(event_tracking_stored_program)
...
END_SERVICE_DEFINITION(event_tracking_stored_program)

#endif  // !MYSQL_COMPONENTS_SERVICES_EVENT_TRACKING_STORED_PROGRAM_SERVICE_H
