...
BEGIN_SERVICE_DEFINITION(registry_registration)
  /**
    ...
    @retval true failure
  */
  DECLARE_BOOL_METHOD(register_service,
  ...
  */
  DECLARE_BOOL_METHOD(unregister,
...
BEGIN_SERVICE_DEFINITION(registry_query)
  ...
  */
  DECLARE_BOOL_METHOD(get,
    (my_h_service_iterator iter, const char** out_name));
  /**
...
BEGIN_SERVICE_DEFINITION(registry_metadata_enumerate)
  ...
  */
  DECLARE_BOOL_METHOD(get,
    (my_h_service_metadata_iterator iterator, const char** name,
      const char** value));
  /**
  ...
  */
  DECLARE_BOOL_METHOD(next,
    (my_h_service_metadata_iterator iterator));
  /**
    Checks if specified iterator is valid, i.e. have not reached one-past-last
    element.
...
BEGIN_SERVICE_DEFINITION(registry_metadata_query)
  ...
  */
  DECLARE_BOOL_METHOD(get_value,
    (my_h_service_iterator iterator, const char* name, const char** value));
