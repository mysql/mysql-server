...
#ifndef COMPONENTS_SERVICES_EVENT_TRACKING_GLOBAL_VARIABLES_SERVICE_H
#define COMPONENTS_SERVICES_EVENT_TRACKING_GLOBAL_VARIABLES_SERVICE_H

#include "mysql/components/service.h"
#include "mysql/components/services/defs/event_tracking_global_variable_defs.h"

/**
  @file mysql/components/services/event_tracking_global_variable_service.h
...
/**
  ...
  @anchor EVENT_TRACKING_GLOBAL_VARIABLE_SERVICE
...
BEGIN_SERVICE_DEFINITION(event_tracking_global_variable)
...
END_SERVICE_DEFINITION(event_tracking_global_variable)

#endif  // COMPONENTS_SERVICES_EVENT_TRACKING_GLOBAL_VARIABLES_SERVICE_H
