...
enum enum_sql_command {
  ...
  SQLCOM_CREATE_RULE,
  SQLCOM_DELETE_RULE,
  SQLCOM_CREATE_USER_ATTRIBUTE,
  SQLCOM_CREATE_OBJECT_ATTRIBUTE,
  SQLCOM_DELETE_USER_ATTRIBUTE,
  SQLCOM_DELETE_OBJECT_ATTRIBUTE,
  SQLCOM_GRANT_USER_ATTRIBUTE,
  SQLCOM_GRANT_OBJECT_ATTRIBUTE,
  SQLCOM_REVOKE_USER_ATTRIBUTE,
  SQLCOM_REVOKE_OBJECT_ATTRIBUTE,
  SQLCOM_END
};
