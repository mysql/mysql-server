...
t7 = new harness.ConcurrentTest("testFindDomainObjectLiteral");
t7.run = function() {
  var testCase = this;
  // use the domain object and literal to find an instance
  var from = global.t_basic;
...
t8 = new harness.ConcurrentTest("testFindDomainObjectLiteral");
t8.run = function() {
  var testCase = this;
  // use the domain object and literal to find an instance
  var from = global.t_basic;
...
t9 = new harness.ConcurrentTest("testFindDomainObjectLiteral");
t9.run = function() {
  var testCase = this;
...
t0 = new harness.ConcurrentTest("testFindDomainObjectLiteral");
t0.run = function() {
  var testCase = this;
  // use the table name and literal to find an instance
  var from = 't_basic';
