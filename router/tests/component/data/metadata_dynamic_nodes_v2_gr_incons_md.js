...
({
  stmts: function (stmt) {
    ...
    // in this test the GR members need to be independent from the nodes in the cluster metadata
    // as we want to test the behavior in case of the metadata inconsistency
    ...
    options_cluster_members.group_replication_primary_member  =
      options_cluster_members.group_replication_membership[mysqld.global.primary_id][0];
