...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTHFBHANDLER_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTHFBHANDLER_H_
...
class Oauth2TwitterHandler : public Oauth2Handler {
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTHFBHANDLER_H_
