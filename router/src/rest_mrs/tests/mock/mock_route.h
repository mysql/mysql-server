...
#ifndef ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_ROUTE_H_
#define ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_ROUTE_H_

#include "mrs/interface/route.h"

class MockRoute : public mrs::interface::Route {
 public:
  ...
  MOCK_METHOD(const VectorOfRowGroupOwnership &, get_group_row_ownership, (),
              (override, const));
  MOCK_METHOD(mrs::interface::RouteSchema *, get_schema, (), (override));
  MOCK_METHOD(collector::MysqlCacheManager *, get_cache, (), (override));

  MOCK_METHOD(void, destroy, (), ());
};

#endif  // ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_ROUTE_H_
