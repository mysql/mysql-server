...
#ifndef ROUTING_CLASSIC_LIST_FIELDS_FORWARDER_INCLUDED
#define ROUTING_CLASSIC_LIST_FIELDS_FORWARDER_INCLUDED

#include "forwarding_processor.h"

class ListFieldsForwarder : public ForwardingProcessor {
 public:
