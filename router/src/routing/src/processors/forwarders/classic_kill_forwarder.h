...
#ifndef ROUTING_SRC_PROCESSORS_FORWARDERS_CLASSIC_KILL_FORWARDER_H_
#define ROUTING_SRC_PROCESSORS_FORWARDERS_CLASSIC_KILL_FORWARDER_H_
...
#endif  // ROUTING_SRC_PROCESSORS_FORWARDERS_CLASSIC_KILL_FORWARDER_H_
