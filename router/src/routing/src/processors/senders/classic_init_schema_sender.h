...
#ifndef ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_INIT_SCHEMA_SENDER_H_
#define ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_INIT_SCHEMA_SENDER_H_
...
#endif  // ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_INIT_SCHEMA_SENDER_H_
