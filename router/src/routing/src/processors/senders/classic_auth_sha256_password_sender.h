...
#ifndef ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_AUTH_SHA256_PASSWORD_SENDER_H_
#define ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_AUTH_SHA256_PASSWORD_SENDER_H_
...
#endif  // ROUTING_SRC_PROCESSORS_SENDERS_CLASSIC_AUTH_SHA256_PASSWORD_SENDER_H_
