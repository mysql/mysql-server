...
#ifndef ROUTING_CLASSIC_STATISTICS_FORWARDER_INCLUDED
#define ROUTING_CLASSIC_STATISTICS_FORWARDER_INCLUDED

#include "forwarding_processor.h"

class StatisticsForwarder : public ForwardingProcessor {
 public:
  ...
  static std::string_view prefix() { return "mysql/statistics"; }
