...
#ifndef ROUTING_CLASSIC_AUTH_OPENID_CONNECT_FORWARDER_INCLUDED
#define ROUTING_CLASSIC_AUTH_OPENID_CONNECT_FORWARDER_INCLUDED
...
class AuthOpenidConnectForwarder : public ForwardingProcessor {
 public:
  AuthOpenidConnectForwarder(MysqlRoutingClassicConnectionBase *conn,
