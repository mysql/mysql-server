...
std::string ROUTER_LIB_EXPORT escape_sql_string(const char *s,
                                                bool wildcards = false);
std::string ROUTER_LIB_EXPORT escape_sql_string(const char *s, int len,
                                                bool wildcards = false);
std::string ROUTER_LIB_EXPORT
escape_sql_string(const std::string &string,
                  bool wildcards = false);  // "strings" or 'strings'
std::string ROUTER_LIB_EXPORT escape_backticks(const char *s,
