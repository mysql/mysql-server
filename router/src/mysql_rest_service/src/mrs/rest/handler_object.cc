...
database::PrimaryKeyColumnValues HandlerObject::get_rest_pk_parameter(
...
std::string HandlerObject::get_path_after_object_name(
    const HttpUri &requests_uri) {
...
HttpResult HandlerObject::handle_put(rest::RequestContext *ctxt) {
...
mrs::database::ObjectRowOwnership HandlerObject::row_ownership_info(
