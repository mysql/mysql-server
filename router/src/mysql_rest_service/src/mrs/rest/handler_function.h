...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_REST_HANDLER_FUNCTION_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_REST_HANDLER_FUNCTION_H_
...
class HandlerFunction : public rest::Handler {
 public:
  using Route = mrs::interface::Object;

 public:
  HandlerFunction(Route *r, mrs::interface::AuthorizeManager *auth_manager);
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_REST_HANDLER_FUNCTION_H_
