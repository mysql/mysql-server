...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTH2_FACEBOOK_HANDLER_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTH2_FACEBOOK_HANDLER_H_
...
class Oauth2FacebookHandler : public Oauth2Handler {
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_AUTHENTICATION_OAUTH2_FACEBOOK_HANDLER_H_
