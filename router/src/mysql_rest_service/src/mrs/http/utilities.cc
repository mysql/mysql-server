...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_HTTP_UTILITIES_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_HTTP_UTILITIES_H_
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_HTTP_UTILITIES_H_
