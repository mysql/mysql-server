...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_SERVICE_OPENAPI_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_SERVICE_OPENAPI_H_
...
class HandlerDbServiceOpenAPI : public mrs::rest::Handler {
 public:
  using DbServiceEndpoint = endpoint::DbServiceEndpoint;
  using DbService = mrs::database::entry::DbService;
  using DbServicePtr = std::shared_ptr<DbService>;

 public:
  HandlerDbServiceOpenAPI(std::weak_ptr<DbServiceEndpoint> endpoint,
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_SERVICE_OPENAPI_H_
