...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_OPENAPI_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_OPENAPI_H_
...
class HandlerDbObjectOpenAPI : public mrs::rest::Handler {
 public:
 ...
 public:
  HandlerDbObjectOpenAPI(std::weak_ptr<DbObjectEndpoint> endpoint,
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_ENDPOINT_HANDLER_HANDLER_DB_OBJECT_OPENAPI_H_
