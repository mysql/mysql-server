...
#ifndef ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_ENDPOINT_CONFIGURATION_H_
#define ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_ENDPOINT_CONFIGURATION_H_

#include <gmock/gmock.h>

#include "mrs/interface/endpoint_configuration.h"

class MockEndpointConfiguration : public mrs::interface::EndpointConfiguration {
 public:
  ...
  MOCK_METHOD(const std::string &, get_mysql_user_data_access, (),
              (const, override));
