...
#ifndef ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_QUERY_ENTRIES_DB_OBJECT_H_
#define ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_QUERY_ENTRIES_DB_OBJECT_H_
...
#endif  // ROUTER_SRC_REST_MRS_TESTS_MOCK_MOCK_QUERY_ENTRIES_DB_OBJECT_H_
