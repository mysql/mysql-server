...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_AUTH_USER_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_AUTH_USER_H_
...
class QueryChangesAuthUser {
 public:
  ...
  ChangedUsersIds &get_changed_ids() { return entries_fetched; }
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_DATABASE_QUERY_CHANGES_AUTH_USER_H_
