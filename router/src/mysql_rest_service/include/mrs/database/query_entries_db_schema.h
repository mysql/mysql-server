...
#ifndef ROUTER_SRC_REST_MRS_SRC_MRS_SCHEMA_DB_SCHEMA_ENTRIES_H_
#define ROUTER_SRC_REST_MRS_SRC_MRS_SCHEMA_DB_SCHEMA_ENTRIES_H_
...
class QueryEntriesDbSchema : protected Query {
 public:
  using DbSchema = entry::DbSchema;
  using VectorOfEntries = std::vector<DbSchema>;
...
#endif  // ROUTER_SRC_REST_MRS_SRC_MRS_SCHEMA_DB_SCHEMA_ENTRIES_H_
