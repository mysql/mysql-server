...
#ifndef ROUTER_SRC_HOST_CACHE_SRC_HOST_CACHE_H_
#define ROUTER_SRC_HOST_CACHE_SRC_HOST_CACHE_H_
...
class HostCache : public mysql_harness::resolver::ResolverInterface {
 public:
  ...
  ResolveHostResult resolve_host(
      ...
      CachePolicy cache_policy = CachePolicy::UseIfPresent) override;
...
#endif  // ROUTER_SRC_HOST_CACHE_SRC_HOST_CACHE_H_
