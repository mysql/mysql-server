...
#ifndef MYSQLROUTER_REST_ROUTING_BLOCKED_HOSTS_INCLUDED
#define MYSQLROUTER_REST_ROUTING_BLOCKED_HOSTS_INCLUDED

#include "mysqlrouter/rest_api_component.h"

class RestRoutingBlockedHosts : public RestApiHandler {
 public:
