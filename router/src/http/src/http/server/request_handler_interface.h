...
#ifndef ROUTER_SRC_HTTP_SRC_HTTP_SERVER_REQUEST_HANDLER_INTERFACE_H_
#define ROUTER_SRC_HTTP_SRC_HTTP_SERVER_REQUEST_HANDLER_INTERFACE_H_
...
#endif  // ROUTER_SRC_HTTP_SRC_HTTP_SERVER_REQUEST_HANDLER_INTERFACE_H_
