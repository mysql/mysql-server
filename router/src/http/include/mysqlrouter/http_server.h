...
#ifndef ROUTER_SRC_HTTP_INCLUDE_MYSQLROUTER_HTTP_SERVER_H_
#define ROUTER_SRC_HTTP_INCLUDE_MYSQLROUTER_HTTP_SERVER_H_
...
#endif  // ROUTER_SRC_HTTP_INCLUDE_MYSQLROUTER_HTTP_SERVER_H_
