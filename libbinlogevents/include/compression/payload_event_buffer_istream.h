...
#include "libbinlogevents/include/buffer/managed_buffer.h"  // mysqlns::buffer::Managed_buffer
#include "libbinlogevents/include/compression/decompressor.h"  // mysqlns::compression::Decompressor
#include "libbinlogevents/include/compression/factory.h"  // mysqlns::compression::Factory
#include "libbinlogevents/include/control_events.h"  // Transaction_payload_event
#include "libbinlogevents/include/event_reader.h"    // Event_reader
...
class Payload_event_buffer_istream {
 public:
  ...
  template <class T>
  using Allocator_t = mysqlns::resource::Allocator<T>;
