...
MetaManager::MetaManager() {
  ...
  std::string config_path = "/mysql_data3/config/compute_node_config.json";
  ...
  int local_port = cJSON_GetObjectItem(local_node, "local_port")->valueint;
...
bool MetaManager::create_instance() {
